...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
{
   ...
   std::experimental::mdspan<KPP_REAL, std::experimental::extents<size_t, std::dynamic_extent>> a_view(ros_A, ros_S * (ros_S - 1) / 2);
   std::experimental::mdspan<KPP_REAL, std::experimental::extents<size_t, std::dynamic_extent>> c_view(ros_C, ros_S * (ros_S - 1) / 2);
   std::experimental::mdspan<KPP_REAL, std::experimental::extents<size_t, std::dynamic_extent, std::dynamic_extent>> k_view(K, ros_S, KPP_NVAR);
