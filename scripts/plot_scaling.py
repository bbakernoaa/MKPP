...
run_both('./build/tests/integration/e2e_validation/benchmark_mkpp_vs_micm', 1000, 100, 'Chapman Mechanism', 'reports/performance_scaling_chapman.png')

# For T1, use 10 steps so it completes in a reasonable time for 10k cells
run_both('./build/tests/integration/e2e_validation/benchmark_mkpp_vs_micm_t1', 1000, 10, 'T1 Mechanism (210 spec, 547 rxn)', 'reports/performance_scaling_t1.png')
