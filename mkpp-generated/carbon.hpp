...
namespace mkpp {
  ...
  struct SolverKernels {
      ...
      KOKKOS_INLINE_FUNCTION void compute_rates(const StateView& state, RateView& F_block, const double* jvals) const {
          ...
          const double R_0 = 6.6007061575166499e-15*state(0);
          const double R_1 = 1.0315008299507354e-13*state(0);
          const double R_2 = 4.2566445999999996e-15;
          const double R_3 = 7.3679649000000001e-14*state(1);
          const double R_4 = 38199.012000000002;
      ...
      KOKKOS_INLINE_FUNCTION void integrate(double dt_total, StateView& state, const double* jvals) const {
          ...
          // --- Reaction Rate Fluxes R_m ---
          const double R_0 = 6.6007061575166499e-15*S_0;
          const double R_1 = 1.0315008299507354e-13*S_0;
          const double R_2 = 4.2566445999999996e-15;
          const double R_3 = 7.3679649000000001e-14*S_1;
          const double R_4 = 38199.012000000002;
