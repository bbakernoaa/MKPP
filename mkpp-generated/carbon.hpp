...
namespace mkpp {
  ...
  struct SolverKernels {
      ...
      KOKKOS_INLINE_FUNCTION void compute_jacobian(const StateView& state, JacView& J_block, const double* jvals) const {
          ...
          J_block(Species::CO, Species::CO) = -7.3679649e-14;
          // J(CO, FixedOH): d(d[CO]/dt) / d[FixedOH]
          J_block(Species::CO, Species::FixedOH) = -7.3679649e-14*state(1);
          // J(CO, DummyCH4): d(d[CO]/dt) / d[DummyCH4]
          J_block(Species::CO, Species::DummyCH4) = 4.2566446e-15;
          // J(CO, DummyNMVOC): d(d[CO]/dt) / d[DummyNMVOC]
          J_block(Species::CO, Species::DummyNMVOC) = 38199.012;
          // J(PCOfromCH4, DummyCH4): d(d[PCOfromCH4]/dt) / d[DummyCH4]
          J_block(Species::PCOfromCH4, Species::DummyCH4) = 4.2566446e-15;
          // J(PCOfromNMVOC, DummyNMVOC): d(d[PCOfromNMVOC]/dt) / d[DummyNMVOC]
          J_block(Species::PCOfromNMVOC, Species::DummyNMVOC) = 38199.012;
          // J(LCH4byOH, CH4): d(d[LCH4byOH]/dt) / d[CH4]
          J_block(Species::LCH4byOH, Species::CH4) = 6.60070615751665e-15;
          // J(LCH4byOH, FixedOH): d(d[LCH4byOH]/dt) / d[FixedOH]
          J_block(Species::LCH4byOH, Species::FixedOH) = 6.60070615751665e-15*state(0);
          ...
          J_block(Species::LCObyOH, Species::CO) = 7.3679649e-14;
          // J(LCObyOH, FixedOH): d(d[LCObyOH]/dt) / d[FixedOH]
          J_block(Species::LCObyOH, Species::FixedOH) = 7.3679649e-14*state(1);
          // J(FixedOH, CH4): d(d[FixedOH]/dt) / d[CH4]
          J_block(Species::FixedOH, Species::CH4) = -6.60070615751665e-15;
          // J(FixedOH, CO): d(d[FixedOH]/dt) / d[CO]
          J_block(Species::FixedOH, Species::CO) = -7.3679649e-14;
          // J(FixedOH, FixedOH): d(d[FixedOH]/dt) / d[FixedOH]
          J_block(Species::FixedOH, Species::FixedOH) = -6.60070615751665e-15*state(0) - 7.3679649e-14*state(1);
          ...
          J_block(Species::DummyCH4, Species::DummyCH4) = -4.2566446e-15;
          // J(DummyNMVOC, DummyNMVOC): d(d[DummyNMVOC]/dt) / d[DummyNMVOC]
          J_block(Species::DummyNMVOC, Species::DummyNMVOC) = -38199.012;
      }
      ...
      KOKKOS_INLINE_FUNCTION void compute_adjoint(const StateView& state, JacView& J_adj_block, const double* jvals) const {
          ...
          J_adj_block(Species::CH4, Species::LCH4byOH) = 6.60070615751665e-15;
          // J^T(CH4, LCH4byCl): d(d[LCH4byCl]/dt) / d[CH4]
          J_adj_block(Species::CH4, Species::LCH4byCl) = 1.0315008299507354e-13;
          // J^T(CH4, FixedOH): d(d[FixedOH]/dt) / d[CH4]
          J_adj_block(Species::CH4, Species::FixedOH) = -6.60070615751665e-15;
          // J^T(CH4, FixedCl): d(d[FixedCl]/dt) / d[CH4]
          J_adj_block(Species::CH4, Species::FixedCl) = -1.0315008299507354e-13;
          ...
          J_adj_block(Species::FixedOH, Species::LCH4byOH) = 6.60070615751665e-15*state(0);
          ...
          J_adj_block(Species::FixedOH, Species::FixedOH) = -6.60070615751665e-15*state(0) - 7.3679649e-14*state(1);
          // J^T(FixedCl, LCH4byCl): d(d[LCH4byCl]/dt) / d[FixedCl]
          J_adj_block(Species::FixedCl, Species::LCH4byCl) = 1.0315008299507354e-13*state(0);
          // J^T(FixedCl, FixedCl): d(d[FixedCl]/dt) / d[FixedCl]
          J_adj_block(Species::FixedCl, Species::FixedCl) = -1.0315008299507354e-13*state(0);
      ...
      KOKKOS_INLINE_FUNCTION void compute_tlm(const StateView& state, const DeltaView& delta_C, RateView& dF_block, const double* jvals) const {
          ...
          dF_block(4) = 0.0;
          dF_block(4) += (6.60070615751665e-15) * delta_C(0);
          dF_block(4) += (6.60070615751665e-15*state(0)) * delta_C(7);
          dF_block(5) = 0.0;
          ...
          dF_block(7) = 0.0;
          dF_block(7) += (-6.60070615751665e-15) * delta_C(0);
          dF_block(7) += (-7.3679649e-14) * delta_C(1);
          dF_block(7) += (-6.60070615751665e-15*state(0) - 7.3679649e-14*state(1)) * delta_C(7);
          dF_block(8) = 0.0;
      ...
      KOKKOS_INLINE_FUNCTION void integrate(double dt_total, StateView& state, const double* jvals) const {
          ...
          double J_6_6 = -6.60070615751665e-15*S_8 - 7.3679649e-14*S_4;
          double J_6_8 = -6.60070615751665e-15;
          double J_7_6 = 6.60070615751665e-15*S_8;
          double J_7_8 = 6.60070615751665e-15;
          ...
          double F1_6 = -6.60070615751665e-15*S_8 - 7.3679649e-14*S_4;
          double F1_7 = 6.60070615751665e-15*S_8;
          double F1_8 = 0.0;
          ...
          double F2_6 = -6.60070615751665e-15*Y2_8 - 7.3679649e-14*Y2_4;
          double F2_7 = 6.60070615751665e-15*Y2_8;
          double F2_8 = 0.0;
          ...
          const CheckpointBuffer& chk) const
      {
          ...
          for (int step = chk.num_steps - 1; step >= 0; step--) {
              ...
              // W^{-T} solve for u3
              // Block 0: u3 transpose forward sub [PCOfromNMVOC]
              double yt3_0 = v3_0 / U_0_0;
              // Block 1: u3 transpose forward sub [PCOfromCH4, LCH4byOH]
              double yt3_1 = v3_1 / U_1_1;
              // Block 2: u3 transpose forward sub [DummyNMVOC]
              double yt3_2 = (v3_2 - U_0_2 * yt3_0) / U_2_2;
              // Block 3: u3 transpose forward sub [DummyCH4]
              double yt3_3 = (v3_3 - U_1_3 * yt3_1) / U_3_3;
              // Block 4: u3 transpose forward sub [CO]
              double yt3_4 = v3_4 / U_4_4;
              // Block 5: u3 transpose forward sub [LCObyOH]
              double yt3_5 = v3_5 / U_5_5;
              // Block 6: u3 transpose forward sub [FixedOH]
              double yt3_6 = (v3_6 - U_4_6 * yt3_4 - U_5_6 * yt3_5) / U_6_6;
              double yt3_7 = v3_7 / U_7_7;
              // Block 7: u3 transpose forward sub [CH4]
              double yt3_8 = (v3_8 - U_6_8 * yt3_6 - U_7_8 * yt3_7) / U_8_8;
              // Block 8: u3 transpose forward sub [LCH4byCl]
              double yt3_9 = v3_9 / U_9_9;
              // Block 9: u3 transpose forward sub [FixedCl]
              double yt3_10 = (v3_10 - U_9_10 * yt3_9) / U_10_10;
              // Block 9: u3 transpose backward sub [FixedCl]
              double u3_10 = yt3_10;
              // Block 8: u3 transpose backward sub [LCH4byCl]
              double u3_9 = yt3_9;
              // Block 7: u3 transpose backward sub [CH4]
              double u3_8 = yt3_8 - L_9_8 * u3_9 - L_10_8 * u3_10;
              // Block 1: u3 transpose backward sub [PCOfromCH4, LCH4byOH]
              double u3_7 = yt3_7;
              // Block 6: u3 transpose backward sub [FixedOH]
              double u3_6 = yt3_6 - L_7_6 * u3_7;
              // Block 5: u3 transpose backward sub [LCObyOH]
              double u3_5 = yt3_5;
              // Block 4: u3 transpose backward sub [CO]
              double u3_4 = yt3_4 - L_5_4 * u3_5 - L_6_4 * u3_6;
              // Block 3: u3 transpose backward sub [DummyCH4]
              double u3_3 = yt3_3 - L_4_3 * u3_4;
              // Block 2: u3 transpose backward sub [DummyNMVOC]
              double u3_2 = yt3_2 - L_4_2 * u3_4;
              double u3_1 = yt3_1;
              // Block 0: u3 transpose backward sub [PCOfromNMVOC]
              double u3_0 = yt3_0;
              ...
              // W^{-T} solve for u2
              // Block 0: u2 transpose forward sub [PCOfromNMVOC]
              double yt2_0 = v2_0 / U_0_0;
              // Block 1: u2 transpose forward sub [PCOfromCH4, LCH4byOH]
              double yt2_1 = v2_1 / U_1_1;
              // Block 2: u2 transpose forward sub [DummyNMVOC]
              double yt2_2 = (v2_2 - U_0_2 * yt2_0) / U_2_2;
              // Block 3: u2 transpose forward sub [DummyCH4]
              double yt2_3 = (v2_3 - U_1_3 * yt2_1) / U_3_3;
              // Block 4: u2 transpose forward sub [CO]
              double yt2_4 = v2_4 / U_4_4;
              // Block 5: u2 transpose forward sub [LCObyOH]
              double yt2_5 = v2_5 / U_5_5;
              // Block 6: u2 transpose forward sub [FixedOH]
              double yt2_6 = (v2_6 - U_4_6 * yt2_4 - U_5_6 * yt2_5) / U_6_6;
              double yt2_7 = v2_7 / U_7_7;
              // Block 7: u2 transpose forward sub [CH4]
              double yt2_8 = (v2_8 - U_6_8 * yt2_6 - U_7_8 * yt2_7) / U_8_8;
              // Block 8: u2 transpose forward sub [LCH4byCl]
              double yt2_9 = v2_9 / U_9_9;
              // Block 9: u2 transpose forward sub [FixedCl]
              double yt2_10 = (v2_10 - U_9_10 * yt2_9) / U_10_10;
              // Block 9: u2 transpose backward sub [FixedCl]
              double u2_10 = yt2_10;
              // Block 8: u2 transpose backward sub [LCH4byCl]
              double u2_9 = yt2_9;
              // Block 7: u2 transpose backward sub [CH4]
              double u2_8 = yt2_8 - L_9_8 * u2_9 - L_10_8 * u2_10;
              // Block 1: u2 transpose backward sub [PCOfromCH4, LCH4byOH]
              double u2_7 = yt2_7;
              // Block 6: u2 transpose backward sub [FixedOH]
              double u2_6 = yt2_6 - L_7_6 * u2_7;
              // Block 5: u2 transpose backward sub [LCObyOH]
              double u2_5 = yt2_5;
              // Block 4: u2 transpose backward sub [CO]
              double u2_4 = yt2_4 - L_5_4 * u2_5 - L_6_4 * u2_6;
              // Block 3: u2 transpose backward sub [DummyCH4]
              double u2_3 = yt2_3 - L_4_3 * u2_4;
              // Block 2: u2 transpose backward sub [DummyNMVOC]
              double u2_2 = yt2_2 - L_4_2 * u2_4;
              double u2_1 = yt2_1;
              // Block 0: u2 transpose backward sub [PCOfromNMVOC]
              double u2_0 = yt2_0;
              ...
              double v1_6 = lam_6 + (J_4_6 * u2_4 + J_5_6 * u2_5 + J_6_6 * u2_6 + J_7_6 * u2_7) + (-1.0156171083877703 / h) * u2_6 + (J_4_6 * u3_4 + J_5_6 * u3_5 + J_6_6 * u3_6 + J_7_6 * u3_7) + (4.0759956452537702 / h) * u3_6;
              double v1_7 = lam_7 + (-1.0156171083877703 / h) * u2_7 + (4.0759956452537702 / h) * u3_7;
              double v1_8 = lam_8 + (J_6_8 * u2_6 + J_7_8 * u2_7 + J_9_8 * u2_9 + J_10_8 * u2_10) + (-1.0156171083877703 / h) * u2_8 + (J_6_8 * u3_6 + J_7_8 * u3_7 + J_9_8 * u3_9 + J_10_8 * u3_10) + (4.0759956452537702 / h) * u3_8;
              ...
              // W^{-T} solve for u1
              // Block 0: u1 transpose forward sub [PCOfromNMVOC]
              double yt1_0 = v1_0 / U_0_0;
              // Block 1: u1 transpose forward sub [PCOfromCH4, LCH4byOH]
              double yt1_1 = v1_1 / U_1_1;
              // Block 2: u1 transpose forward sub [DummyNMVOC]
              double yt1_2 = (v1_2 - U_0_2 * yt1_0) / U_2_2;
              // Block 3: u1 transpose forward sub [DummyCH4]
              double yt1_3 = (v1_3 - U_1_3 * yt1_1) / U_3_3;
              // Block 4: u1 transpose forward sub [CO]
              double yt1_4 = v1_4 / U_4_4;
              // Block 5: u1 transpose forward sub [LCObyOH]
              double yt1_5 = v1_5 / U_5_5;
              // Block 6: u1 transpose forward sub [FixedOH]
              double yt1_6 = (v1_6 - U_4_6 * yt1_4 - U_5_6 * yt1_5) / U_6_6;
              double yt1_7 = v1_7 / U_7_7;
              // Block 7: u1 transpose forward sub [CH4]
              double yt1_8 = (v1_8 - U_6_8 * yt1_6 - U_7_8 * yt1_7) / U_8_8;
              // Block 8: u1 transpose forward sub [LCH4byCl]
              double yt1_9 = v1_9 / U_9_9;
              // Block 9: u1 transpose forward sub [FixedCl]
              double yt1_10 = (v1_10 - U_9_10 * yt1_9) / U_10_10;
              // Block 9: u1 transpose backward sub [FixedCl]
              double u1_10 = yt1_10;
              // Block 8: u1 transpose backward sub [LCH4byCl]
              double u1_9 = yt1_9;
              // Block 7: u1 transpose backward sub [CH4]
              double u1_8 = yt1_8 - L_9_8 * u1_9 - L_10_8 * u1_10;
              // Block 1: u1 transpose backward sub [PCOfromCH4, LCH4byOH]
              double u1_7 = yt1_7;
              // Block 6: u1 transpose backward sub [FixedOH]
              double u1_6 = yt1_6 - L_7_6 * u1_7;
              // Block 5: u1 transpose backward sub [LCObyOH]
              double u1_5 = yt1_5;
              // Block 4: u1 transpose backward sub [CO]
              double u1_4 = yt1_4 - L_5_4 * u1_5 - L_6_4 * u1_6;
              // Block 3: u1 transpose backward sub [DummyCH4]
              double u1_3 = yt1_3 - L_4_3 * u1_4;
              // Block 2: u1 transpose backward sub [DummyNMVOC]
              double u1_2 = yt1_2 - L_4_2 * u1_4;
              double u1_1 = yt1_1;
              // Block 0: u1 transpose backward sub [PCOfromNMVOC]
              double u1_0 = yt1_0;
          ...
          const CheckpointBuffer& chk) const
      {
          ...
          for (int step = 0; step < chk.num_steps; step++) {
              ...
              double tlm_rhs2_8 = (-1.0156171083877703 / h) * dK1_8;
              ...
              // Block 0: dK2 forward sub [PCOfromNMVOC]
              double tlm_y2_0 = tlm_rhs2_0;
              // Block 1: dK2 forward sub [PCOfromCH4, LCH4byOH]
              double tlm_y2_1 = tlm_rhs2_1;
              // Block 2: dK2 forward sub [DummyNMVOC]
              double tlm_y2_2 = tlm_rhs2_2;
              // Block 3: dK2 forward sub [DummyCH4]
              double tlm_y2_3 = tlm_rhs2_3;
              // Block 4: dK2 forward sub [CO]
              double tlm_y2_4 = tlm_rhs2_4 - L_4_2 * tlm_y2_2 - L_4_3 * tlm_y2_3;
              // Block 5: dK2 forward sub [LCObyOH]
              double tlm_y2_5 = tlm_rhs2_5 - L_5_4 * tlm_y2_4;
              // Block 6: dK2 forward sub [FixedOH]
              double tlm_y2_6 = tlm_rhs2_6 - L_6_4 * tlm_y2_4;
              double tlm_y2_7 = tlm_rhs2_7 - L_7_6 * tlm_y2_6;
              // Block 7: dK2 forward sub [CH4]
              double tlm_y2_8 = tlm_rhs2_8;
              // Block 8: dK2 forward sub [LCH4byCl]
              double tlm_y2_9 = tlm_rhs2_9 - L_9_8 * tlm_y2_8;
              // Block 9: dK2 forward sub [FixedCl]
              double tlm_y2_10 = tlm_rhs2_10 - L_10_8 * tlm_y2_8;
              // Block 9: dK2 backward sub [FixedCl]
              double dK2_10 = tlm_y2_10 / U_10_10;
              // Block 8: dK2 backward sub [LCH4byCl]
              double dK2_9 = (tlm_y2_9 - U_9_10 * dK2_10) / U_9_9;
              // Block 7: dK2 backward sub [CH4]
              double dK2_8 = tlm_y2_8 / U_8_8;
              // Block 1: dK2 backward sub [PCOfromCH4, LCH4byOH]
              double dK2_7 = (tlm_y2_7 - U_7_8 * dK2_8) / U_7_7;
              // Block 6: dK2 backward sub [FixedOH]
              double dK2_6 = (tlm_y2_6 - U_6_8 * dK2_8) / U_6_6;
              // Block 5: dK2 backward sub [LCObyOH]
              double dK2_5 = (tlm_y2_5 - U_5_6 * dK2_6) / U_5_5;
              // Block 4: dK2 backward sub [CO]
              double dK2_4 = (tlm_y2_4 - U_4_6 * dK2_6) / U_4_4;
              // Block 3: dK2 backward sub [DummyCH4]
              double dK2_3 = tlm_y2_3 / U_3_3;
              // Block 2: dK2 backward sub [DummyNMVOC]
              double dK2_2 = tlm_y2_2 / U_2_2;
              double dK2_1 = (tlm_y2_1 - U_1_3 * dK2_3) / U_1_1;
              // Block 0: dK2 backward sub [PCOfromNMVOC]
              ...
              double tlm_rhs3_8 = (4.0759956452537702 / h) * dK1_8 + (9.20767942983308 / h) * dK2_8;
              ...
              // Block 0: dK3 forward sub [PCOfromNMVOC]
              double tlm_y3_0 = tlm_rhs3_0;
              // Block 1: dK3 forward sub [PCOfromCH4, LCH4byOH]
              double tlm_y3_1 = tlm_rhs3_1;
              // Block 2: dK3 forward sub [DummyNMVOC]
              double tlm_y3_2 = tlm_rhs3_2;
              // Block 3: dK3 forward sub [DummyCH4]
              double tlm_y3_3 = tlm_rhs3_3;
              // Block 4: dK3 forward sub [CO]
              double tlm_y3_4 = tlm_rhs3_4 - L_4_2 * tlm_y3_2 - L_4_3 * tlm_y3_3;
              // Block 5: dK3 forward sub [LCObyOH]
              double tlm_y3_5 = tlm_rhs3_5 - L_5_4 * tlm_y3_4;
              // Block 6: dK3 forward sub [FixedOH]
              double tlm_y3_6 = tlm_rhs3_6 - L_6_4 * tlm_y3_4;
              double tlm_y3_7 = tlm_rhs3_7 - L_7_6 * tlm_y3_6;
              // Block 7: dK3 forward sub [CH4]
              double tlm_y3_8 = tlm_rhs3_8;
              // Block 8: dK3 forward sub [LCH4byCl]
              double tlm_y3_9 = tlm_rhs3_9 - L_9_8 * tlm_y3_8;
              // Block 9: dK3 forward sub [FixedCl]
              double tlm_y3_10 = tlm_rhs3_10 - L_10_8 * tlm_y3_8;
              // Block 9: dK3 backward sub [FixedCl]
              double dK3_10 = tlm_y3_10 / U_10_10;
              // Block 8: dK3 backward sub [LCH4byCl]
              double dK3_9 = (tlm_y3_9 - U_9_10 * dK3_10) / U_9_9;
              // Block 7: dK3 backward sub [CH4]
              double dK3_8 = tlm_y3_8 / U_8_8;
              // Block 1: dK3 backward sub [PCOfromCH4, LCH4byOH]
              double dK3_7 = (tlm_y3_7 - U_7_8 * dK3_8) / U_7_7;
              // Block 6: dK3 backward sub [FixedOH]
              double dK3_6 = (tlm_y3_6 - U_6_8 * dK3_8) / U_6_6;
              // Block 5: dK3 backward sub [LCObyOH]
              double dK3_5 = (tlm_y3_5 - U_5_6 * dK3_6) / U_5_5;
              // Block 4: dK3 backward sub [CO]
              double dK3_4 = (tlm_y3_4 - U_4_6 * dK3_6) / U_4_4;
              // Block 3: dK3 backward sub [DummyCH4]
              double dK3_3 = tlm_y3_3 / U_3_3;
              // Block 2: dK3 backward sub [DummyNMVOC]
              double dK3_2 = tlm_y3_2 / U_2_2;
              double dK3_1 = (tlm_y3_1 - U_1_3 * dK3_3) / U_1_1;
              // Block 0: dK3 backward sub [PCOfromNMVOC]
