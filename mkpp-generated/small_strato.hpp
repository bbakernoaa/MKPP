...
struct SolverKernels {
    ...
    void compute_rates(const StateView& state, RateView& F_block) const {
        F_block(0) = 7.1100000000000005e-11 * state(5) * state(1) -
                     1.0690000000000001e-11 * state(4) * state(0) + 0.01289 * state(4) -
                     8.0180000000000003e-17 * state(0) * state(6) -
                     1.576e-15 * state(0) * state(2) + 5.2860000000000002e-10 * state(6) +
                     0.00061200000000000002 * state(2);
        F_block(1) = -7.1100000000000005e-11 * state(5) * state(1) - 1.2e-10 * state(1) * state(2) +
                     0.00107 * state(2);
        F_block(2) = -6.0620000000000003e-15 * state(3) * state(2) +
                     8.0180000000000003e-17 * state(0) * state(6) -
                     1.576e-15 * state(0) * state(2) - 1.2e-10 * state(1) * state(2) -
                     0.0016819999999999999 * state(2);
        F_block(3) = -6.0620000000000003e-15 * state(3) * state(2) +
                     1.0690000000000001e-11 * state(4) * state(0) + 0.01289 * state(4);
        F_block(4) = 6.0620000000000003e-15 * state(3) * state(2) -
                     1.0690000000000001e-11 * state(4) * state(0) - 0.01289 * state(4);
        F_block(5) = 0.0;
        F_block(6) = 0.0;
    }
    ...
    void compute_jacobian(const StateView& state, JacView& J_block) const {
        J_block(0, 0) = -1.0690000000000001e-11 * state(4) - 8.0180000000000003e-17 * state(6) -
                        1.576e-15 * state(2);
        ...
        J_block(2, 2) = -6.0620000000000003e-15 * state(3) - 1.576e-15 * state(0) -
                        1.2e-10 * state(1) - 0.0016819999999999999;
    ...
    void compute_tlm(const StateView& state, const DeltaView& delta_C, RateView& dF_block) const {
        dF_block(0) = 0.0;
        dF_block(0) += (-1.0690000000000001e-11 * state(4) - 8.0180000000000003e-17 * state(6) -
                        1.576e-15 * state(2)) *
                       delta_C(0);
        ...
        dF_block(2) += (-6.0620000000000003e-15 * state(3) - 1.576e-15 * state(0) -
                        1.2e-10 * state(1) - 0.0016819999999999999) *
                       delta_C(2);
    ...
    KOKKOS_INLINE_FUNCTION
    void integrate(double dt_total, StateView& state) const {
        ...
        while (t < dt_total) {
            ...
            // 1. Stage 1 Rates (F1)
            double F1_0 = 7.1100000000000005e-11 * S_5 * S_1 - 1.0690000000000001e-11 * S_4 * S_0 +
                          0.01289 * S_4 - 8.0180000000000003e-17 * S_0 * S_6 -
                          1.576e-15 * S_0 * S_2 + 5.2860000000000002e-10 * S_6 +
                          0.00061200000000000002 * S_2;
            double F1_1 = -7.1100000000000005e-11 * S_5 * S_1 - 1.2e-10 * S_1 * S_2 + 0.00107 * S_2;
            double F1_2 = -6.0620000000000003e-15 * S_3 * S_2 + 8.0180000000000003e-17 * S_0 * S_6 -
                          1.576e-15 * S_0 * S_2 - 1.2e-10 * S_1 * S_2 - 0.0016819999999999999 * S_2;
            double F1_3 = -6.0620000000000003e-15 * S_3 * S_2 + 1.0690000000000001e-11 * S_4 * S_0 +
                          0.01289 * S_4;
            double F1_4 = 6.0620000000000003e-15 * S_3 * S_2 - 1.0690000000000001e-11 * S_4 * S_0 -
                          0.01289 * S_4;
            double F1_5 = 0.0;
            double F1_6 = 0.0;
            ...
            double J_0_0 =
                -1.0690000000000001e-11 * S_4 - 8.0180000000000003e-17 * S_6 - 1.576e-15 * S_2;
            ...
            double J_2_2 = -6.0620000000000003e-15 * S_3 - 1.576e-15 * S_0 - 1.2e-10 * S_1 -
                           0.0016819999999999999;
            ...
            double K1_2 =
                (y1_2 - U_2_3 * K1_3 - U_2_4 * K1_4 - U_2_5 * K1_5 - U_2_6 * K1_6) / U_2_2;
            double K1_1 = (y1_1 - U_1_2 * K1_2 - U_1_5 * K1_5) / U_1_1;
            double K1_0 =
                (y1_0 - U_0_1 * K1_1 - U_0_2 * K1_2 - U_0_4 * K1_4 - U_0_5 * K1_5 - U_0_6 * K1_6) /
                U_0_0;
            ...
            double F2_0 = 7.1100000000000005e-11 * Ynew_5 * Ynew_1 -
                          1.0690000000000001e-11 * Ynew_4 * Ynew_0 + 0.01289 * Ynew_4 -
                          8.0180000000000003e-17 * Ynew_0 * Ynew_6 - 1.576e-15 * Ynew_0 * Ynew_2 +
                          5.2860000000000002e-10 * Ynew_6 + 0.00061200000000000002 * Ynew_2;
            double rhs2_0 = F2_0 + (ros_C0 / dt) * K1_0;
            double F2_1 = -7.1100000000000005e-11 * Ynew_5 * Ynew_1 - 1.2e-10 * Ynew_1 * Ynew_2 +
                          0.00107 * Ynew_2;
            double rhs2_1 = F2_1 + (ros_C0 / dt) * K1_1;
            double F2_2 = -6.0620000000000003e-15 * Ynew_3 * Ynew_2 +
                          8.0180000000000003e-17 * Ynew_0 * Ynew_6 - 1.576e-15 * Ynew_0 * Ynew_2 -
                          1.2e-10 * Ynew_1 * Ynew_2 - 0.0016819999999999999 * Ynew_2;
            double rhs2_2 = F2_2 + (ros_C0 / dt) * K1_2;
            double F2_3 = -6.0620000000000003e-15 * Ynew_3 * Ynew_2 +
                          1.0690000000000001e-11 * Ynew_4 * Ynew_0 + 0.01289 * Ynew_4;
            double rhs2_3 = F2_3 + (ros_C0 / dt) * K1_3;
            double F2_4 = 6.0620000000000003e-15 * Ynew_3 * Ynew_2 -
                          1.0690000000000001e-11 * Ynew_4 * Ynew_0 - 0.01289 * Ynew_4;
            ...
            double K2_2 =
                (y2_2 - U_2_3 * K2_3 - U_2_4 * K2_4 - U_2_5 * K2_5 - U_2_6 * K2_6) / U_2_2;
            double K2_1 = (y2_1 - U_1_2 * K2_2 - U_1_5 * K2_5) / U_1_1;
            double K2_0 =
                (y2_0 - U_0_1 * K2_1 - U_0_2 * K2_2 - U_0_4 * K2_4 - U_0_5 * K2_5 - U_0_6 * K2_6) /
                U_0_0;
    ...
    template <class StateView>
    KOKKOS_INLINE_FUNCTION
    void integrate_with_reduction(double dt_total, StateView& state,
        ...
        while (t < dt_total) {
            ...
            active[0] = (Kokkos::fabs(F1_0) / (atol[0] + rtol[0] * Kokkos::fabs(state(0))) >=
                         importance_threshold);
            active[1] = (Kokkos::fabs(F1_1) / (atol[1] + rtol[1] * Kokkos::fabs(state(1))) >=
                         importance_threshold);
            active[2] = (Kokkos::fabs(F1_2) / (atol[2] + rtol[2] * Kokkos::fabs(state(2))) >=
                         importance_threshold);
            active[3] = (Kokkos::fabs(F1_3) / (atol[3] + rtol[3] * Kokkos::fabs(state(3))) >=
                         importance_threshold);
            active[4] = (Kokkos::fabs(F1_4) / (atol[4] + rtol[4] * Kokkos::fabs(state(4))) >=
                         importance_threshold);
            active[5] = (Kokkos::fabs(F1_5) / (atol[5] + rtol[5] * Kokkos::fabs(state(5))) >=
                         importance_threshold);
            active[6] = (Kokkos::fabs(F1_6) / (atol[6] + rtol[6] * Kokkos::fabs(state(6))) >=
                         importance_threshold);
            ...
            double y1_4 = active[4]
                              ? (F1_4 - L_4_0 * y1_0 - L_4_1 * y1_1 - L_4_2 * y1_2 - L_4_3 * y1_3)
                              : 0.0;
            ...
            double K1_3 =
                active[3] ? ((y1_3 - U_3_4 * K1_4 - U_3_5 * K1_5 - U_3_6 * K1_6) / U_3_3) : 0.0;
            double K1_2 =
                active[2]
                    ? ((y1_2 - U_2_3 * K1_3 - U_2_4 * K1_4 - U_2_5 * K1_5 - U_2_6 * K1_6) / U_2_2)
                    : 0.0;
            double K1_1 = active[1] ? ((y1_1 - U_1_2 * K1_2 - U_1_5 * K1_5) / U_1_1) : 0.0;
            double K1_0 = active[0] ? ((y1_0 - U_0_1 * K1_1 - U_0_2 * K1_2 - U_0_4 * K1_4 -
                                        U_0_5 * K1_5 - U_0_6 * K1_6) /
                                       U_0_0)
                                    : 0.0;
            ...
            double y2_4 = active[4]
                              ? (rhs2_4 - L_4_0 * y2_0 - L_4_1 * y2_1 - L_4_2 * y2_2 - L_4_3 * y2_3)
                              : 0.0;
            ...
            double K2_3 =
                active[3] ? ((y2_3 - U_3_4 * K2_4 - U_3_5 * K2_5 - U_3_6 * K2_6) / U_3_3) : 0.0;
            double K2_2 =
                active[2]
                    ? ((y2_2 - U_2_3 * K2_3 - U_2_4 * K2_4 - U_2_5 * K2_5 - U_2_6 * K2_6) / U_2_2)
                    : 0.0;
            double K2_1 = active[1] ? ((y2_1 - U_1_2 * K2_2 - U_1_5 * K2_5) / U_1_1) : 0.0;
            double K2_0 = active[0] ? ((y2_0 - U_0_1 * K2_1 - U_0_2 * K2_2 - U_0_4 * K2_4 -
                                        U_0_5 * K2_5 - U_0_6 * K2_6) /
                                       U_0_0)
                                    : 0.0;
