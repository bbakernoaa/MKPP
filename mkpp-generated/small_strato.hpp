...
namespace mkpp {
  ...
  struct SolverKernels {
      ...
      KOKKOS_INLINE_FUNCTION void integrate(double dt_total, StateView& state, const double* jvals) const {
          ...
          double J_0_0 = -6.0620000000000003e-15*S_2 - 1.576e-15*S_4 - 1.2e-10*S_3 - 1.0*jvals[1] - 1.0*jvals[2];
          double J_0_1 = 8.0180000000000003e-17*S_6 - 1.576e-15*S_5;
          double J_0_2 = -1.2e-10*S_5;
          double J_0_5 = -6.0620000000000003e-15*S_5;
          double J_0_6 = 8.0180000000000003e-17*S_4;
          double J_1_0 = -1.576e-15*S_4 + 1.0*jvals[1];
          double J_1_1 = -1.0690000000000001e-11*S_1 - 8.0180000000000003e-17*S_6 - 1.576e-15*S_5;
          double J_1_2 = 7.1100000000000005e-11*S_0;
          double J_1_3 = -1.0690000000000001e-11*S_4 + 1.0*jvals[3];
          double J_1_4 = 7.1100000000000005e-11*S_3;
          double J_1_6 = -8.0180000000000003e-17*S_4 + 2.0*jvals[0];
          double J_2_0 = -1.2e-10*S_3 + 1.0*jvals[2];
          double J_2_2 = -7.1100000000000005e-11*S_0 - 1.2e-10*S_5;
          double J_2_4 = -7.1100000000000005e-11*S_3;
          double J_3_0 = 6.0620000000000003e-15*S_2;
          double J_3_1 = -1.0690000000000001e-11*S_1;
          double J_3_3 = -1.0690000000000001e-11*S_4 - 1.0*jvals[3];
          double J_3_5 = 6.0620000000000003e-15*S_5;
          double J_5_0 = -6.0620000000000003e-15*S_2;
          double J_5_1 = 1.0690000000000001e-11*S_1;
          double J_5_3 = 1.0690000000000001e-11*S_4 + 1.0*jvals[3];
          double J_5_5 = -6.0620000000000003e-15*S_5;
