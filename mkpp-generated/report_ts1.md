# MKPP Mechanism Diagnostic Report: ts1
...
d[PAN]/dt = (IMPLICIT: 3.79334033753023e+17*0.6**(1.0/(log(7213620.55230525*M_density/Temp**2.5)**2/log(10)**2 + 1.0))*C_CH3CO3*C_NO2*M_density/(Temp**4.1*(7213620.55230525*M_density/Temp**2.5 + 1.0)) - 6.99817769619201e+27*0.6**(1.0/(log(7213620.55230525*M_density/Temp**2.5)**2/log(10)**2 + 1.0))*C_PAN*M_density*exp(-14000.0/Temp)/(Temp**4.1*(7213620.55230525*M_density/Temp**2.5 + 1.0)) - 24088.56304*C_OH*C_PAN - 1.0*C_PAN*J_45) + (EXPLICIT: 0)
...
d[SO3]/dt = (IMPLICIT: 1.50694342175858e+15*0.6**(1.0/(log(4605972855.5381*M_density/Temp**4.3)**2/log(10)**2 + 1.0))*C_OH*C_SO2*M_density/(Temp**4.1*(4605972855.5381*M_density/Temp**4.3 + 1.0)) - 3.08262524332654e-5*C_H2O**2*C_SO3*exp(-6540.0/Temp) + 1.0*C_H2SO4*J_20 - 1.0*C_SO3*J_63) + (EXPLICIT: 0)
...
d[N2O5]/dt = (IMPLICIT: -6.72818511823084e+21*0.6**(1.0/(log(43143765.9284615*M_density/Temp**3.1)**2/log(10)**2 + 1.0))*C_N2O5*M_density*exp(-10840.0/Temp)/(Temp**3.0*(43143765.9284615*M_density/Temp**3.1 + 1.0)) + 23500484207948.2*0.6**(1.0/(log(43143765.9284615*M_density/Temp**3.1)**2/log(10)**2 + 1.0))*C_NO2*C_NO3*M_density/(Temp**3.0*(43143765.9284615*M_density/Temp**3.1 + 1.0)) - 1.0*C_N2O5*J_34 - 1.0*C_N2O5*J_55 - 1.0*C_N2O5*Rate_540 - 1.0*C_N2O5*Rate_542 - 1.0*C_N2O5*Rate_543) + (EXPLICIT: 0)
d[HCN]/dt = (IMPLICIT: -11495120.3318927*0.8**(1.0/(log(483386275402558.0*M_density/Temp**6.1)**2/log(10)**2 + 1.0))*C_HCN*C_OH*M_density/(Temp**1.5*(483386275402558.0*M_density/Temp**6.1 + 1.0)) - 65039120.208*C_HCN*C_O1D*exp(-105.0/Temp)) + (EXPLICIT: 0)
...
d[HNO3]/dt = (IMPLICIT: 17625363155961.1*0.6**(1.0/(log(1045271.57477143*M_density/Temp**3.0)**2/log(10)**2 + 1.0))*C_NO2*C_OH*M_density/(Temp**3.0*(1045271.57477143*M_density/Temp**3.0 + 1.0)) - 235.730165666147*1.0**(1.0/(log(14.4977462740741*M_density*exp(864.0/Temp))**2/log(10)**2 + 1.0))*C_HNO3*C_OH*M_density*exp(-1335.0/Temp)/(14.4977462740741*M_density*exp(864.0/Temp) + 1.0) + 1.0*C_BRONO2*Rate_530 + 1.0*C_BRONO2*Rate_533 + 1.0*C_BRONO2*Rate_535 + 361328.4456*C_CH2O*C_NO3*exp(2058.0/Temp) + 843099.7064*C_CH3CHO*C_NO3*exp(1900.0/Temp) + 843099.7064*C_CH3COCHO*C_NO3*exp(1860.0/Temp) + 1.0*C_CLONO2*C_HCL*Rate_539 + 1.0*C_CLONO2*C_HCL*Rate_544 + 1.0*C_CLONO2*C_HCL*Rate_546 + 1.0*C_CLONO2*Rate_534 + 1.0*C_CLONO2*Rate_536 + 1.0*C_CLONO2*Rate_538 + 114420.67444*C_DMS*C_NO3*exp(-520.0/Temp) - 3613284.456*C_F*C_HNO3*exp(-400.0/Temp) - 14453.137824*C_HNO3*C_OH*exp(-460.0/Temp) - 1.0*C_HNO3*J_96 + 1.0*C_N2O5*Rate_540 + 1.0*C_N2O5*Rate_542 + 1.0*C_N2O5*Rate_543) + (EXPLICIT: 0)
d[ACBZO2]/dt = (IMPLICIT: 4.83187534943584e+31*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_PBZNIT*M_density*exp(-14000.0/Temp)/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)) - 2.61910292430935e+21*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_ACBZO2*C_NO2*M_density/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)) - 258952.05268*C_ACBZO2*C_HO2*exp(-1040.0/Temp) - 4516605.57*C_ACBZO2*C_NO*exp(-290.0/Temp) + 3553063.0484*C_BZALD*C_OH*exp(-225.0/Temp)) + (EXPLICIT: 0)
...
d[HYAC]/dt = (IMPLICIT: 1.35680108835454e+18*0.5**(1.0/(log(75100707119.8905*M_density/Temp**3.5)**2/log(10)**2 + 1.0))*C_MPAN*C_OH*M_density/(Temp**3.5*(75100707119.8905*M_density/Temp**3.5 + 1.0)) + 8430997.064*C_CH3CO3*C_MACRO2 + 782878.2988*C_CH3CO3*C_XO2*exp(-640.0/Temp) + 301107.038*C_CH3O2*C_MACRO2*exp(-400.0/Temp) + 427571.99396*C_CH3O2*C_RO2*exp(-500.0/Temp) + 301107.038*C_CH3O2*C_XO2*exp(-400.0/Temp) + 1.0*C_HONITR*J_84 - 1806642.228*C_HYAC*C_OH - 1.0*C_HYAC*J_27 + 2649741.9344*C_ISOPBO2*C_NO*exp(-180.0/Temp) + 1445313.7824*C_ISOPBO2*C_NO3 + 24088563.04*C_ISOPNITA*C_OH + 24088563.04*C_ISOPNITB*C_OH + 1625978.0052*C_MACRO2*C_NO*exp(-360.0/Temp) + 1445313.7824*C_MACRO2*C_NO3 + 1625978.0052*C_NO*C_XO2*exp(-360.0/Temp) + 1445313.7824*C_NO3*C_XO2 + 2288413.4888*C_OH*C_POOH*exp(-200.0/Temp)) + (EXPLICIT: 0)
...
d[NO2]/dt = (IMPLICIT: 4.83187534943584e+31*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_MPAN*M_density*exp(-14000.0/Temp)/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)) + 4.83187534943584e+31*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_PBZNIT*M_density*exp(-14000.0/Temp)/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)) - 2.61910292430935e+21*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_ACBZO2*C_NO2*M_density/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)) - 2.61910292430935e+21*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_MCO3*C_NO2*M_density/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)) - 18216614662964.4*0.6**(1.0/(log(1366219.25440128*M_density/Temp**3.1)**2/log(10)**2 + 1.0))*C_HO2*C_NO2*M_density/(Temp**3.4*(1366219.25440128*M_density/Temp**3.1 + 1.0)) + 1.44044763426211e+22*0.6**(1.0/(log(1366219.25440128*M_density/Temp**3.1)**2/log(10)**2 + 1.0))*C_HO2NO2*M_density*exp(-10900.0/Temp)/(Temp**3.4*(1366219.25440128*M_density/Temp**3.1 + 1.0)) + 6.72818511823084e+21*0.6**(1.0/(log(43143765.9284615*M_density/Temp**3.1)**2/log(10)**2 + 1.0))*C_N2O5*M_density*exp(-10840.0/Temp)/(Temp**3.0*(43143765.9284615*M_density/Temp**3.1 + 1.0)) - 23500484207948.2*0.6**(1.0/(log(43143765.9284615*M_density/Temp**3.1)**2/log(10)**2 + 1.0))*C_NO2*C_NO3*M_density/(Temp**3.0*(43143765.9284615*M_density/Temp**3.1 + 1.0)) - 17625363155961.1*0.6**(1.0/(log(1045271.57477143*M_density/Temp**3.0)**2/log(10)**2 + 1.0))*C_NO2*C_OH*M_density/(Temp**3.0*(1045271.57477143*M_density/Temp**3.0 + 1.0)) - 3.79334033753023e+17*0.6**(1.0/(log(7213620.55230525*M_density/Temp**2.5)**2/log(10)**2 + 1.0))*C_CH3CO3*C_NO2*M_density/(Temp**4.1*(7213620.55230525*M_density/Temp**2.5 + 1.0)) + 6.99817769619201e+27*0.6**(1.0/(log(7213620.55230525*M_density/Temp**2.5)**2/log(10)**2 + 1.0))*C_PAN*M_density*exp(-14000.0/Temp)/(Temp**4.1*(7213620.55230525*M_density/Temp**2.5 + 1.0)) + 169600136.044318*0.6**(1.0/(log(9.38758838998631*M_density/Temp**1.5)**2/log(10)**2 + 1.0))*C_NO*C_O*M_density/(Temp**1.5*(9.38758838998631*M_density/Temp**1.5 + 1.0)) - 17257845470176.8*0.6**(1.0/(log(37.5503535599452*M_density/Temp**1.5)**2/log(10)**2 + 1.0))*C_CLO*C_NO2*M_density/(Temp**3.4*(37.5503535599452*M_density/Temp**1.5 + 1.0)) - 2607714680.55594*0.6**(1.0/(log(3.63163012865838*M_density/Temp**1.1)**2/log(10)**2 + 1.0))*C_NO2*C_O*M_density/(Temp**1.8*(3.63163012865838*M_density/Temp**1.1 + 1.0)) - 15932838847979.2*0.6**(1.0/(log(0.251212665537336*M_density/Temp**0.3)**2/log(10)**2 + 1.0))*C_BRO*C_NO2*M_density/(Temp**3.2*(0.251212665537336*M_density/Temp**0.3 + 1.0)) + 4516605.57*C_ACBZO2*C_NO*exp(-290.0/Temp) + 963542.5216*C_ALKNIT*C_OH + 1.0*C_ALKNIT*J_59 + 4034834.3092*C_ALKO2*C_NO + 1565756.5976*C_BENZO2*C_NO*exp(-365.0/Temp) + 210774.9266*C_BIGENE*C_NO3 + 5299483.8688*C_BRO*C_NO*exp(-260.0/Temp) + 1.0*C_BRONO2*J_13 + 1565756.5976*C_BZOO*C_NO*exp(-365.0/Temp) + 1565756.5976*C_C2H5O2*C_NO*exp(-365.0/Temp) + 2529299.1192*C_C3H7O2*C_NO*exp(-180.0/Temp) + 1565756.5976*C_C6H5O2*C_NO*exp(-365.0/Temp) + 4877934.0156*C_CH3CO3*C_NO*exp(-270.0/Temp) + 1686199.4128*C_CH3O2*C_NO*exp(-300.0/Temp) + 1204428.152*C_CH3O2*C_NTERPO2*exp(-500.0/Temp) + 3854170.0864*C_CLO*C_NO*exp(-290.0/Temp) + 1.0*C_CLONO2*J_52 + 4516605.57*C_DICARBO2*C_NO*exp(-290.0/Temp) + 2890627.5648*C_ENEO2*C_NO*exp(-120.0/Temp) + 2529299.1192*C_EO2*C_NO*exp(-180.0/Temp) + 1.0*C_HNO3*J_96 + 2071616.42144*C_HO2*C_NO*exp(-260.0/Temp) + 2107749.266*C_HO2*C_NO3 + 270996.3342*C_HO2NO2*C_OH*exp(-610.0/Temp) + 1.0*C_HO2NO2*J_44 + 1565756.5976*C_HOCH2OO*C_NO*exp(-265.0/Temp) + 1.0*C_HONITR*J_84 + 2649741.9344*C_ISOPAO2*C_NO*exp(-180.0/Temp) + 1445313.7824*C_ISOPAO2*C_NO3 + 2649741.9344*C_ISOPBO2*C_NO*exp(-180.0/Temp) + 1445313.7824*C_ISOPBO2*C_NO3 + 24088563.04*C_ISOPNITA*C_OH + 1625978.0052*C_ISOPNO3*C_NO*exp(-360.0/Temp) + 1445313.7824*C_ISOPNO3*C_NO3 + 1.0*C_ISOPNOOH*J_36 + 1625978.0052*C_MACRO2*C_NO*exp(-360.0/Temp) + 1445313.7824*C_MACRO2*C_NO3 + 4516605.57*C_MALO2*C_NO*exp(-290.0/Temp) + 3191734.6028*C_MCO3*C_NO*exp(-360.0/Temp) + 3011070.38*C_MCO3*C_NO3 + 4516605.57*C_MDIALO2*C_NO*exp(-290.0/Temp) + 2529299.1192*C_MEKO2*C_NO*exp(-180.0/Temp) + 1.0*C_MPAN*J_102 - 3492841.6408*C_N*C_NO2*exp(-220.0/Temp) + 1.0*C_N2O5*J_55 + 1.0*C_NC4CHO*J_83 + 10237639.292*C_NO*C_NO3*exp(-125.0/Temp) + 2529299.1192*C_NO*C_NTERPO2*exp(-180.0/Temp) + 1806642.228*C_NO*C_O3*exp(1500.0/Temp) + 1565756.5976*C_NO*C_PHENO2*exp(-365.0/Temp) + 2529299.1192*C_NO*C_PO2*exp(-180.0/Temp) + 1746420.8204*C_NO*C_RO2*exp(-300.0/Temp) + 2529299.1192*C_NO*C_TERP2O2*exp(-180.0/Temp) + 2529299.1192*C_NO*C_TERPO2*exp(-180.0/Temp) + 1565756.5976*C_NO*C_TOLO2*exp(-365.0/Temp) + 1625978.0052*C_NO*C_XO2*exp(-360.0/Temp) + 1565756.5976*C_NO*C_XYLENO2*exp(-365.0/Temp) + 1565756.5976*C_NO*C_XYLOLO2*exp(-365.0/Temp) - 3071291.7876*C_NO2*C_O*exp(-210.0/Temp) - 72265.68912*C_NO2*C_O3*exp(2450.0/Temp) - 8430997.064*C_NO2*C_SO - 1.0*C_NO2*J_75 + 1445313.7824*C_NO3*C_NTERPO2 + 7828782.988*C_NO3*C_O + 13248709.672*C_NO3*C_OH + 1445313.7824*C_NO3*C_XO2 + 1.0*C_NO3*J_88 + 403483.43092*C_NOA*C_OH + 1.0*C_NOA*J_19 + 1.0*C_NTERPOOH*J_22 + 12044281.52*C_OH*C_TERPNIT + 1.0*C_ONITR*J_91 + 1.0*C_PAN*J_45 + 1.0*C_TERPNIT*J_0) + (EXPLICIT: -2.61910292430935e+21*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_DICARBO2*C_NO2*M_density/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)) - 2.61910292430935e+21*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_MALO2*C_NO2*M_density/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)) - 2.61910292430935e+21*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_MDIALO2*C_NO2*M_density/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)) - 1264649.5596*C_NO2*C_PHENO)
...
d[CL2O2]/dt = (IMPLICIT: 5700224004796.99*0.6**(1.0/(log(278.320559448649*M_density/Temp**2.0)**2/log(10)**2 + 1.0))*C_CLO**2*M_density/(Temp**3.6*(278.320559448649*M_density/Temp**2.0 + 1.0)) - 4.38215030167017e+21*0.6**(1.0/(log(278.320559448649*M_density/Temp**2.0)**2/log(10)**2 + 1.0))*C_CL2O2*M_density*exp(-8537.0/Temp)/(Temp**3.6*(278.320559448649*M_density/Temp**2.0 + 1.0)) - 1.0*C_CL2O2*J_58) + (EXPLICIT: 0)
d[CLO]/dt = (IMPLICIT: -11400448009594.0*0.6**(1.0/(log(278.320559448649*M_density/Temp**2.0)**2/log(10)**2 + 1.0))*C_CLO**2*M_density/(Temp**3.6*(278.320559448649*M_density/Temp**2.0 + 1.0)) + 4.38215030167017e+21*0.6**(1.0/(log(278.320559448649*M_density/Temp**2.0)**2/log(10)**2 + 1.0))*C_CL2O2*M_density*exp(-8537.0/Temp)/(Temp**3.6*(278.320559448649*M_density/Temp**2.0 + 1.0)) - 17257845470176.8*0.6**(1.0/(log(37.5503535599452*M_density/Temp**1.5)**2/log(10)**2 + 1.0))*C_CLO*C_NO2*M_density/(Temp**3.4*(37.5503535599452*M_density/Temp**1.5 + 1.0)) - 572103.3722*C_BRO*C_CLO*exp(-550.0/Temp) - 246907.77116*C_BRO*C_CLO*exp(-290.0/Temp) - 1385092.3748*C_BRO*C_CLO*exp(-260.0/Temp) - 1987306.4508*C_CH3O2*C_CLO*exp(115.0/Temp) + 21679706.736*C_CL*C_HO2*exp(375.0/Temp) + 2047527.8584*C_CL*C_HOCL*exp(130.0/Temp) + 13850923.748*C_CL*C_O3*exp(200.0/Temp) - 421549.8532*C_CLO**2*exp(1370.0/Temp) - 1204428.152*C_CLO**2*exp(1590.0/Temp) - 36132844.56*C_CLO**2*exp(2450.0/Temp) - 1565756.5976*C_CLO*C_HO2*exp(-290.0/Temp) - 3854170.0864*C_CLO*C_NO*exp(-290.0/Temp) - 16861994.128*C_CLO*C_O*exp(-85.0/Temp) - 4456384.1624*C_CLO*C_OH*exp(-270.0/Temp) - 361328.4456*C_CLO*C_OH*exp(-230.0/Temp) - 16861994.128*C_CLO*C_SO - 1.0*C_CLO*J_117 + 2167970.6736*C_CLONO2*C_O*exp(840.0/Temp) + 1.0*C_CLONO2*J_52 + 1987306.4508*C_HCL*C_O1D + 102376.39292*C_HOCL*C_O + 1806642.228*C_HOCL*C_OH*exp(500.0/Temp) + 1144206.7444*C_OCLO*C_SO + 1.0*C_OCLO*J_30) + (EXPLICIT: 0)
d[CLONO2]/dt = (IMPLICIT: 17257845470176.8*0.6**(1.0/(log(37.5503535599452*M_density/Temp**1.5)**2/log(10)**2 + 1.0))*C_CLO*C_NO2*M_density/(Temp**3.4*(37.5503535599452*M_density/Temp**1.5 + 1.0)) - 3914391.494*C_CL*C_CLONO2*exp(-135.0/Temp) - 1.0*C_CLONO2*C_HCL*Rate_539 - 1.0*C_CLONO2*C_HCL*Rate_544 - 1.0*C_CLONO2*C_HCL*Rate_546 - 2167970.6736*C_CLONO2*C_O*exp(840.0/Temp) - 722656.8912*C_CLONO2*C_OH*exp(330.0/Temp) - 1.0*C_CLONO2*J_103 - 1.0*C_CLONO2*J_52 - 1.0*C_CLONO2*Rate_534 - 1.0*C_CLONO2*Rate_536 - 1.0*C_CLONO2*Rate_538) + (EXPLICIT: 0)
d[HCOOH]/dt = (IMPLICIT: 1994639.86332894*0.6**(1.0/(log(359151.768216867*M_density/Temp**2.0)**2/log(10)**2 + 1.0))*C_C2H2*C_OH*M_density/(359151.768216867*M_density/Temp**2.0 + 1.0) + 7226.568912*C_BCARY*C_O3 + 7226.568912*C_C2H4*C_O3*exp(2630.0/Temp) + 3914.391494*C_C3H6*C_O3*exp(1900.0/Temp) - 240885.6304*C_HCOOH*C_OH + 451660.557*C_HO2*C_HOCH2OO*exp(-700.0/Temp) + 1565756.5976*C_HOCH2OO*C_NO*exp(-265.0/Temp) + 6323.247798*C_ISOP*C_O3*exp(2000.0/Temp) + 903.321114*C_MACR*C_O3*exp(2100.0/Temp) + 379.39486788*C_MTERP*C_O3*exp(580.0/Temp) + 511.8819646*C_MVK*C_O3*exp(1520.0/Temp)) + (EXPLICIT: 0)
...
d[C2H4]/dt = (IMPLICIT: -1.48962223300274e+15*0.48**(1.0/(log(2155408.87775621*M_density/Temp**2.25)**2/log(10)**2 + 1.0))*C_C2H4*C_OH*M_density/(Temp**3.1*(2155408.87775621*M_density/Temp**2.25 + 1.0)) - 867205309126295.0*0.6**(1.0/(log(15484.1752157504*M_density/Temp**2.3)**2/log(10)**2 + 1.0))*C_C2H4*C_CL*M_density/(Temp**3.3*(15484.1752157504*M_density/Temp**2.3 + 1.0)) - 7226.568912*C_C2H4*C_O3*exp(2630.0/Temp)) + (EXPLICIT: 0)
...
d[H2O2]/dt = (IMPLICIT: 75070991.2198345*0.6**(1.0/(log(4.79455052815385*M_density/Temp**1.0)**2/log(10)**2 + 1.0))*C_OH**2*M_density/(Temp**1.0*(4.79455052815385*M_density/Temp**1.0 + 1.0)) - 6624354.836*C_CL*C_H2O2*exp(980.0/Temp) + 0.642096108110429*C_H2O*C_HO2**2*C_M*exp(-3120.0/Temp) + 152.317953199664*C_H2O*C_HO2**2*exp(-2660.0/Temp) - 843099.7064*C_H2O2*C_O*exp(2000.0/Temp) - 1083985.3368*C_H2O2*C_OH - 1.0*C_H2O2*J_29 + 761.589765998321*C_HO2**2*C_M*exp(-920.0/Temp) + 180664.2228*C_HO2**2*exp(-460.0/Temp)) + (EXPLICIT: 0)
...
d[MALO2]/dt = (IMPLICIT: 1.0*C_BIGALD1*J_95 - 258952.05268*C_HO2*C_MALO2*exp(-1040.0/Temp) - 4516605.57*C_MALO2*C_NO*exp(-290.0/Temp)) + (EXPLICIT: -2.61910292430935e+21*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_MALO2*C_NO2*M_density/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)))
...
d[MCO3]/dt = (IMPLICIT: 4.83187534943584e+31*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_MPAN*M_density*exp(-14000.0/Temp)/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)) - 2.61910292430935e+21*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_MCO3*C_NO2*M_density/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)) - 2770184.7496*C_CH3CO3*C_MCO3*exp(-530.0/Temp) - 1204428.152*C_CH3O2*C_MCO3*exp(-500.0/Temp) - 258952.05268*C_HO2*C_MCO3*exp(-1040.0/Temp) + 5781255.1296*C_MACR*C_OH*exp(-360.0/Temp) + 1.0*C_MACR*J_32 + 13850923.748*C_MACROOH*C_OH*exp(-200.0/Temp) - 2770184.7496*C_MCO3**2*exp(-530.0/Temp) - 3191734.6028*C_MCO3*C_NO*exp(-360.0/Temp) - 3011070.38*C_MCO3*C_NO3 + 1.0*C_MPAN*J_102) + (EXPLICIT: 0)
d[MDIALO2]/dt = (IMPLICIT: 1.0*C_BIGALD3*J_76 - 258952.05268*C_HO2*C_MDIALO2*exp(-1040.0/Temp) - 4516605.57*C_MDIALO2*C_NO*exp(-290.0/Temp)) + (EXPLICIT: -2.61910292430935e+21*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_MDIALO2*C_NO2*M_density/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)))
...
d[EO2]/dt = (IMPLICIT: 1.48962223300274e+15*0.48**(1.0/(log(2155408.87775621*M_density/Temp**2.25)**2/log(10)**2 + 1.0))*C_C2H4*C_OH*M_density/(Temp**3.1*(2155408.87775621*M_density/Temp**2.25 + 1.0)) - 451660.557*C_EO2*C_HO2*exp(-700.0/Temp) - 2529299.1192*C_EO2*C_NO*exp(-180.0/Temp)) + (EXPLICIT: 0)
...
d[PBZNIT]/dt = (IMPLICIT: -4.83187534943584e+31*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_PBZNIT*M_density*exp(-14000.0/Temp)/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)) + 2.61910292430935e+21*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_ACBZO2*C_NO2*M_density/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0))) + (EXPLICIT: 0)
d[XYLENES]/dt = (IMPLICIT: -10237639.292*C_OH*C_XYLENES) + (EXPLICIT: 0)
d[PO2]/dt = (IMPLICIT: 1.35680108835454e+18*0.5**(1.0/(log(75100707119.8905*M_density/Temp**3.5)**2/log(10)**2 + 1.0))*C_C3H6*C_OH*M_density/(Temp**3.5*(75100707119.8905*M_density/Temp**3.5 + 1.0)) - 451660.557*C_HO2*C_PO2*exp(-700.0/Temp) - 2529299.1192*C_NO*C_PO2*exp(-180.0/Temp) + 2288413.4888*C_OH*C_POOH*exp(-200.0/Temp)) + (EXPLICIT: 0)
...
d[DICARBO2]/dt = (IMPLICIT: 1.0*C_BIGALD2*J_49 - 258952.05268*C_DICARBO2*C_HO2*exp(-1040.0/Temp) - 4516605.57*C_DICARBO2*C_NO*exp(-290.0/Temp)) + (EXPLICIT: -2.61910292430935e+21*0.6**(1.0/(log(89998823549.6937*M_density/Temp**4.1)**2/log(10)**2 + 1.0))*C_DICARBO2*C_NO2*M_density/(Temp**5.6*(89998823549.6937*M_density/Temp**4.1 + 1.0)))
...
d[HO2NO2]/dt = (IMPLICIT: 18216614662964.4*0.6**(1.0/(log(1366219.25440128*M_density/Temp**3.1)**2/log(10)**2 + 1.0))*C_HO2*C_NO2*M_density/(Temp**3.4*(1366219.25440128*M_density/Temp**3.1 + 1.0)) - 1.44044763426211e+22*0.6**(1.0/(log(1366219.25440128*M_density/Temp**3.1)**2/log(10)**2 + 1.0))*C_HO2NO2*M_density*exp(-10900.0/Temp)/(Temp**3.4*(1366219.25440128*M_density/Temp**3.1 + 1.0)) - 270996.3342*C_HO2NO2*C_OH*exp(-610.0/Temp) - 1.0*C_HO2NO2*J_44 - 1.0*C_HO2NO2*J_50) + (EXPLICIT: 0)
