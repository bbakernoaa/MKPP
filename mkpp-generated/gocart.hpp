...
namespace mkpp {
  ...
  struct SolverKernels {
      ...
      KOKKOS_INLINE_FUNCTION void compute_rates(const StateView& state, RateView& F_block, const double* jvals) const {
          ...
          F_block(18) = 0.0;
          F_block(19) = 0.0;
          F_block(20) = -0.025000000000000001*state(10)*state(20) - 0.025000000000000001*state(11)*state(20) - 0.025000000000000001*state(12)*state(20) - 0.025000000000000001*state(13)*state(20) - 0.025000000000000001*state(14)*state(20) - 1.0*state(20)*state(21)*state(5)*Rate_27 - 0.025000000000000001*state(20)*state(15) - 0.025000000000000001*state(20)*state(16) - 0.025000000000000001*state(20)*state(17) - 0.025000000000000001*state(20)*state(18) - 0.025000000000000001*state(20)*state(19);
          F_block(21) = -1.0*state(20)*state(21)*state(5)*Rate_27;
          F_block(22) = 1.0*state(20)*state(21)*state(5)*Rate_27;
          F_block(23) = 0.025000000000000001*state(10)*state(20) + 0.025000000000000001*state(13)*state(20) + 1.0*state(20)*state(21)*state(5)*Rate_27 + 0.025000000000000001*state(20)*state(16) + 0.025000000000000001*state(20)*state(19);
      ...
      KOKKOS_INLINE_FUNCTION void compute_jacobian(const StateView& state, JacView& J_block, const double* jvals) const {
          ...
          J_block(23, 20) = 0.025000000000000001*state(10) + 0.025000000000000001*state(13) + 1.0*state(21)*state(5)*Rate_27 + 0.025000000000000001*state(16) + 0.025000000000000001*state(19);
      ...
      KOKKOS_INLINE_FUNCTION void compute_adjoint(const StateView& state, JacView& J_adj_block, const double* jvals) const {
          ...
          J_adj_block(20, 23) = 0.025000000000000001*state(10) + 0.025000000000000001*state(13) + 1.0*state(21)*state(5)*Rate_27 + 0.025000000000000001*state(16) + 0.025000000000000001*state(19);
      ...
      KOKKOS_INLINE_FUNCTION void compute_tlm(const StateView& state, const DeltaView& delta_C, RateView& dF_block, const double* jvals) const {
          ...
          dF_block(20) += (-0.025000000000000001*state(10) - 0.025000000000000001*state(11) - 0.025000000000000001*state(12) - 0.025000000000000001*state(13) - 0.025000000000000001*state(14) - 1.0*state(21)*state(5)*Rate_27 - 0.025000000000000001*state(15) - 0.025000000000000001*state(16) - 0.025000000000000001*state(17) - 0.025000000000000001*state(18) - 0.025000000000000001*state(19)) * delta_C(20);
          ...
          dF_block(23) += (0.025000000000000001*state(10) + 0.025000000000000001*state(13) + 1.0*state(21)*state(5)*Rate_27 + 0.025000000000000001*state(16) + 0.025000000000000001*state(19)) * delta_C(20);
      ...
      KOKKOS_INLINE_FUNCTION void integrate(double dt_total, StateView& state, const double* jvals) const {
          ...
          double J_8_10 = 1.0*S_20*S_5*Rate_27;
          ...
          double J_8_19 = 1.0*S_20*S_21*Rate_27;
          double J_8_21 = 0.025000000000000001*S_10 + 0.025000000000000001*S_13 + 1.0*S_21*S_5*Rate_27 + 0.025000000000000001*S_16 + 0.025000000000000001*S_19;
          ...
          double J_10_10 = -1.0*S_20*S_5*Rate_27;
          double J_10_19 = -1.0*S_20*S_21*Rate_27;
          double J_10_21 = -1.0*S_21*S_5*Rate_27;
          double J_18_10 = 1.0*S_20*S_5*Rate_27;
          double J_18_19 = 1.0*S_20*S_21*Rate_27;
          double J_18_21 = 1.0*S_21*S_5*Rate_27;
          double J_19_4 = 3.3000000000000001e-12*S_4;
          double J_19_6 = 0.0025000000000000001*S_4;
          double J_19_10 = -1.0*S_20*S_5*Rate_27;
          ...
          double J_19_19 = -1.0*S_20*S_21*Rate_27;
          ...
          double J_19_21 = -1.0*S_21*S_5*Rate_27;
          ...
          double J_21_10 = -1.0*S_20*S_5*Rate_27;
          ...
          double J_21_19 = -1.0*S_20*S_21*Rate_27;
          double J_21_21 = -0.025000000000000001*S_10 - 0.025000000000000001*S_11 - 0.025000000000000001*S_12 - 0.025000000000000001*S_13 - 0.025000000000000001*S_14 - 1.0*S_21*S_5*Rate_27 - 0.025000000000000001*S_15 - 0.025000000000000001*S_16 - 0.025000000000000001*S_17 - 0.025000000000000001*S_18 - 0.025000000000000001*S_19;
          ...
          double F1_5 = 2.5000000000000001e-5*S_10*S_4 + 2.5000000000000001e-5*S_11*S_4 + 2.5000000000000001e-5*S_12*S_4 + 2.5000000000000001e-5*S_13*S_4 + 2.5000000000000001e-5*S_14*S_4 + 0.0025000000000000001*S_2*S_4 - 1.0*S_20*S_21*S_5*Rate_27 + 3.3000000000000001e-12*S_0*S_4 + 0.00025000000000000001*S_4*S_15 + 0.00025000000000000001*S_4*S_16 + 0.00025000000000000001*S_4*S_17 + 0.00025000000000000001*S_4*S_18 + 0.00025000000000000001*S_4*S_19;
          ...
          double F1_18 = 0.0;
          double F1_19 = 0.0;
          double F1_20 = -0.025000000000000001*S_10*S_20 - 0.025000000000000001*S_11*S_20 - 0.025000000000000001*S_12*S_20 - 0.025000000000000001*S_13*S_20 - 0.025000000000000001*S_14*S_20 - 1.0*S_20*S_21*S_5*Rate_27 - 0.025000000000000001*S_20*S_15 - 0.025000000000000001*S_20*S_16 - 0.025000000000000001*S_20*S_17 - 0.025000000000000001*S_20*S_18 - 0.025000000000000001*S_20*S_19;
          double F1_21 = -1.0*S_20*S_21*S_5*Rate_27;
          double F1_22 = 1.0*S_20*S_21*S_5*Rate_27;
          double F1_23 = 0.025000000000000001*S_10*S_20 + 0.025000000000000001*S_13*S_20 + 1.0*S_20*S_21*S_5*Rate_27 + 0.025000000000000001*S_20*S_16 + 0.025000000000000001*S_20*S_19;
          ...
          double F2_5 = 2.5000000000000001e-5*Y2_10*Y2_4 + 2.5000000000000001e-5*Y2_11*Y2_4 + 2.5000000000000001e-5*Y2_12*Y2_4 + 2.5000000000000001e-5*Y2_13*Y2_4 + 2.5000000000000001e-5*Y2_14*Y2_4 + 0.0025000000000000001*Y2_2*Y2_4 - 1.0*Y2_20*Y2_21*Y2_5*Rate_27 + 3.3000000000000001e-12*Y2_0*Y2_4 + 0.00025000000000000001*Y2_4*Y2_15 + 0.00025000000000000001*Y2_4*Y2_16 + 0.00025000000000000001*Y2_4*Y2_17 + 0.00025000000000000001*Y2_4*Y2_18 + 0.00025000000000000001*Y2_4*Y2_19;
          ...
          double F2_18 = 0.0;
          double F2_19 = 0.0;
          double F2_20 = -0.025000000000000001*Y2_10*Y2_20 - 0.025000000000000001*Y2_11*Y2_20 - 0.025000000000000001*Y2_12*Y2_20 - 0.025000000000000001*Y2_13*Y2_20 - 0.025000000000000001*Y2_14*Y2_20 - 1.0*Y2_20*Y2_21*Y2_5*Rate_27 - 0.025000000000000001*Y2_20*Y2_15 - 0.025000000000000001*Y2_20*Y2_16 - 0.025000000000000001*Y2_20*Y2_17 - 0.025000000000000001*Y2_20*Y2_18 - 0.025000000000000001*Y2_20*Y2_19;
          double F2_21 = -1.0*Y2_20*Y2_21*Y2_5*Rate_27;
          double F2_22 = 1.0*Y2_20*Y2_21*Y2_5*Rate_27;
          double F2_23 = 0.025000000000000001*Y2_10*Y2_20 + 0.025000000000000001*Y2_13*Y2_20 + 1.0*Y2_20*Y2_21*Y2_5*Rate_27 + 0.025000000000000001*Y2_20*Y2_16 + 0.025000000000000001*Y2_20*Y2_19;
