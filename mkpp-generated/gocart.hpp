...
namespace mkpp {
  ...
  struct SolverKernels {
      ...
      KOKKOS_INLINE_FUNCTION void compute_rates(const StateView& state, RateView& F_block) const {
          F_block(0) = -5.0442046141041832e-12*state(3)*state(0) + 2.0000000000000002e-5*state(2) - 3.3000000000000001e-12*state(0)*state(4);
          F_block(1) = -3.3571944693753379e-14*state(3)*state(1);
          F_block(2) = -0.0025000000000000001*state(2)*state(4) - 1.0000000000000001e-5*state(2);
      ...
      KOKKOS_INLINE_FUNCTION void integrate(double dt, StateView& state) const {
          ...
          // 1. Stage 1 Rates (F1)
          double F1_0 = -5.0442046141041832e-12*state(3)*state(0) + 2.0000000000000002e-5*state(2) - 3.3000000000000001e-12*state(0)*state(4);
          double F1_1 = -3.3571944693753379e-14*state(3)*state(1);
          double F1_2 = -0.0025000000000000001*state(2)*state(4) - 1.0000000000000001e-5*state(2);
          double F1_3 = -3.3571944693753379e-14*state(3)*state(1) - 5.0442046141041832e-12*state(3)*state(0);
          double F1_4 = 3.3571944693753379e-14*state(3)*state(1) + 5.0442046141041832e-12*state(3)*state(0) - 2.5000000000000001e-5*state(10)*state(4) - 2.5000000000000001e-5*state(11)*state(4) - 2.5000000000000001e-5*state(12)*state(4) - 2.5000000000000001e-5*state(13)*state(4) - 2.5000000000000001e-5*state(14)*state(4) - 0.0025000000000000001*state(2)*state(4) - 3.3000000000000001e-12*state(0)*state(4) - 0.00025000000000000001*state(4)*state(15) - 0.00025000000000000001*state(4)*state(16) - 0.00025000000000000001*state(4)*state(17) - 0.00025000000000000001*state(4)*state(18) - 0.00025000000000000001*state(4)*state(19);
          double F1_5 = 2.5000000000000001e-5*state(10)*state(4) + 2.5000000000000001e-5*state(11)*state(4) + 2.5000000000000001e-5*state(12)*state(4) + 2.5000000000000001e-5*state(13)*state(4) + 2.5000000000000001e-5*state(14)*state(4) + 0.0025000000000000001*state(2)*state(4) - 1.0*state(20)*state(21)*state(5)*Rate_27 + 3.3000000000000001e-12*state(0)*state(4) + 0.00025000000000000001*state(4)*state(15) + 0.00025000000000000001*state(4)*state(16) + 0.00025000000000000001*state(4)*state(17) + 0.00025000000000000001*state(4)*state(18) + 0.00025000000000000001*state(4)*state(19);
          ...
          double F1_18 = 0.0;
          double F1_19 = 0.0;
          double F1_20 = -0.025000000000000001*state(10)*state(20) - 0.025000000000000001*state(11)*state(20) - 0.025000000000000001*state(12)*state(20) - 0.025000000000000001*state(13)*state(20) - 0.025000000000000001*state(14)*state(20) - 1.0*state(20)*state(21)*state(5)*Rate_27 - 0.025000000000000001*state(20)*state(15) - 0.025000000000000001*state(20)*state(16) - 0.025000000000000001*state(20)*state(17) - 0.025000000000000001*state(20)*state(18) - 0.025000000000000001*state(20)*state(19);
          double F1_21 = -1.0*state(20)*state(21)*state(5)*Rate_27;
          double F1_22 = 1.0*state(20)*state(21)*state(5)*Rate_27;
          double F1_23 = 0.025000000000000001*state(10)*state(20) + 0.025000000000000001*state(13)*state(20) + 1.0*state(20)*state(21)*state(5)*Rate_27 + 0.025000000000000001*state(20)*state(16) + 0.025000000000000001*state(20)*state(19);
          double F1_24 = 0.025000000000000001*state(11)*state(20) + 0.025000000000000001*state(14)*state(20) + 0.025000000000000001*state(20)*state(17);
          double F1_25 = 0.025000000000000001*state(12)*state(20) + 0.025000000000000001*state(20)*state(15) + 0.025000000000000001*state(20)*state(18);
          ...
          double J_4_4 = -2.5000000000000001e-5*state(10) - 2.5000000000000001e-5*state(11) - 2.5000000000000001e-5*state(12) - 2.5000000000000001e-5*state(13) - 2.5000000000000001e-5*state(14) - 0.0025000000000000001*state(2) - 3.3000000000000001e-12*state(0) - 0.00025000000000000001*state(15) - 0.00025000000000000001*state(16) - 0.00025000000000000001*state(17) - 0.00025000000000000001*state(18) - 0.00025000000000000001*state(19);
          ...
          double J_5_4 = 2.5000000000000001e-5*state(10) + 2.5000000000000001e-5*state(11) + 2.5000000000000001e-5*state(12) + 2.5000000000000001e-5*state(13) + 2.5000000000000001e-5*state(14) + 0.0025000000000000001*state(2) + 3.3000000000000001e-12*state(0) + 0.00025000000000000001*state(15) + 0.00025000000000000001*state(16) + 0.00025000000000000001*state(17) + 0.00025000000000000001*state(18) + 0.00025000000000000001*state(19);
          ...
          double J_20_20 = -0.025000000000000001*state(10) - 0.025000000000000001*state(11) - 0.025000000000000001*state(12) - 0.025000000000000001*state(13) - 0.025000000000000001*state(14) - 1.0*state(21)*state(5)*Rate_27 - 0.025000000000000001*state(15) - 0.025000000000000001*state(16) - 0.025000000000000001*state(17) - 0.025000000000000001*state(18) - 0.025000000000000001*state(19);
          ...
          double J_23_20 = 0.025000000000000001*state(10) + 0.025000000000000001*state(13) + 1.0*state(21)*state(5)*Rate_27 + 0.025000000000000001*state(16) + 0.025000000000000001*state(19);
          ...
          double J_24_20 = 0.025000000000000001*state(11) + 0.025000000000000001*state(14) + 0.025000000000000001*state(17);
          ...
          double J_25_20 = 0.025000000000000001*state(12) + 0.025000000000000001*state(15) + 0.025000000000000001*state(18);
          ...
          double y1_18 = F1_18;
          double y1_19 = F1_19;
          double y1_20 = F1_20 - L_20_5 * y1_5 - L_20_10 * y1_10 - L_20_11 * y1_11 - L_20_12 * y1_12 - L_20_13 * y1_13 - L_20_14 * y1_14 - L_20_15 * y1_15 - L_20_16 * y1_16 - L_20_17 * y1_17 - L_20_18 * y1_18 - L_20_19 * y1_19;
          double y1_21 = F1_21 - L_21_5 * y1_5 - L_21_10 * y1_10 - L_21_11 * y1_11 - L_21_12 * y1_12 - L_21_13 * y1_13 - L_21_14 * y1_14 - L_21_15 * y1_15 - L_21_16 * y1_16 - L_21_17 * y1_17 - L_21_18 * y1_18 - L_21_19 * y1_19 - L_21_20 * y1_20;
          double y1_22 = F1_22 - L_22_5 * y1_5 - L_22_10 * y1_10 - L_22_11 * y1_11 - L_22_12 * y1_12 - L_22_13 * y1_13 - L_22_14 * y1_14 - L_22_15 * y1_15 - L_22_16 * y1_16 - L_22_17 * y1_17 - L_22_18 * y1_18 - L_22_19 * y1_19 - L_22_20 * y1_20 - L_22_21 * y1_21;
          double y1_23 = F1_23 - L_23_5 * y1_5 - L_23_10 * y1_10 - L_23_11 * y1_11 - L_23_12 * y1_12 - L_23_13 * y1_13 - L_23_14 * y1_14 - L_23_15 * y1_15 - L_23_16 * y1_16 - L_23_17 * y1_17 - L_23_18 * y1_18 - L_23_19 * y1_19 - L_23_20 * y1_20 - L_23_21 * y1_21;
          double y1_24 = F1_24 - L_24_11 * y1_11 - L_24_14 * y1_14 - L_24_17 * y1_17 - L_24_20 * y1_20 - L_24_21 * y1_21;
          double y1_25 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_0 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_1 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_2 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_3 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_4 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_5 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_6 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_7 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_8 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_9 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_10 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_11 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_12 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_13 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_14 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_15 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_16 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_17 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_18 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_19 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_20 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_21 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_22 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_23 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_24 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          double K1_25 = F1_25 - L_25_12 * y1_12 - L_25_15 * y1_15 - L_25_18 * y1_18 - L_25_20 * y1_20 - L_25_21 * y1_21;
          ...
          double F2_0 = -5.0442046141041832e-12*Ynew_3*Ynew_0 + 2.0000000000000002e-5*Ynew_2 - 3.3000000000000001e-12*Ynew_0*Ynew_4;
          ...
          double F2_3 = -3.3571944693753379e-14*Ynew_3*Ynew_1 - 5.0442046141041832e-12*Ynew_3*Ynew_0;
          double rhs2_3 = F2_3 + (ros_C0 / dt) * K1_3;
          double F2_4 = 3.3571944693753379e-14*Ynew_3*Ynew_1 + 5.0442046141041832e-12*Ynew_3*Ynew_0 - 2.5000000000000001e-5*Ynew_10*Ynew_4 - 2.5000000000000001e-5*Ynew_11*Ynew_4 - 2.5000000000000001e-5*Ynew_12*Ynew_4 - 2.5000000000000001e-5*Ynew_13*Ynew_4 - 2.5000000000000001e-5*Ynew_14*Ynew_4 - 0.0025000000000000001*Ynew_2*Ynew_4 - 3.3000000000000001e-12*Ynew_0*Ynew_4 - 0.00025000000000000001*Ynew_4*Ynew_15 - 0.00025000000000000001*Ynew_4*Ynew_16 - 0.00025000000000000001*Ynew_4*Ynew_17 - 0.00025000000000000001*Ynew_4*Ynew_18 - 0.00025000000000000001*Ynew_4*Ynew_19;
          double rhs2_4 = F2_4 + (ros_C0 / dt) * K1_4;
          double F2_5 = 2.5000000000000001e-5*Ynew_10*Ynew_4 + 2.5000000000000001e-5*Ynew_11*Ynew_4 + 2.5000000000000001e-5*Ynew_12*Ynew_4 + 2.5000000000000001e-5*Ynew_13*Ynew_4 + 2.5000000000000001e-5*Ynew_14*Ynew_4 + 0.0025000000000000001*Ynew_2*Ynew_4 - 1.0*Ynew_20*Ynew_21*Ynew_5*Rate_27 + 3.3000000000000001e-12*Ynew_0*Ynew_4 + 0.00025000000000000001*Ynew_4*Ynew_15 + 0.00025000000000000001*Ynew_4*Ynew_16 + 0.00025000000000000001*Ynew_4*Ynew_17 + 0.00025000000000000001*Ynew_4*Ynew_18 + 0.00025000000000000001*Ynew_4*Ynew_19;
          ...
          double F2_20 = -0.025000000000000001*Ynew_10*Ynew_20 - 0.025000000000000001*Ynew_11*Ynew_20 - 0.025000000000000001*Ynew_12*Ynew_20 - 0.025000000000000001*Ynew_13*Ynew_20 - 0.025000000000000001*Ynew_14*Ynew_20 - 1.0*Ynew_20*Ynew_21*Ynew_5*Rate_27 - 0.025000000000000001*Ynew_20*Ynew_15 - 0.025000000000000001*Ynew_20*Ynew_16 - 0.025000000000000001*Ynew_20*Ynew_17 - 0.025000000000000001*Ynew_20*Ynew_18 - 0.025000000000000001*Ynew_20*Ynew_19;
          ...
          double F2_23 = 0.025000000000000001*Ynew_10*Ynew_20 + 0.025000000000000001*Ynew_13*Ynew_20 + 1.0*Ynew_20*Ynew_21*Ynew_5*Rate_27 + 0.025000000000000001*Ynew_20*Ynew_16 + 0.025000000000000001*Ynew_20*Ynew_19;
          double rhs2_23 = F2_23 + (ros_C0 / dt) * K1_23;
          double F2_24 = 0.025000000000000001*Ynew_11*Ynew_20 + 0.025000000000000001*Ynew_14*Ynew_20 + 0.025000000000000001*Ynew_20*Ynew_17;
          double rhs2_24 = F2_24 + (ros_C0 / dt) * K1_24;
          double F2_25 = 0.025000000000000001*Ynew_12*Ynew_20 + 0.025000000000000001*Ynew_20*Ynew_15 + 0.025000000000000001*Ynew_20*Ynew_18;
          ...
          double y2_20 = rhs2_20 - L_20_5 * y2_5 - L_20_10 * y2_10 - L_20_11 * y2_11 - L_20_12 * y2_12 - L_20_13 * y2_13 - L_20_14 * y2_14 - L_20_15 * y2_15 - L_20_16 * y2_16 - L_20_17 * y2_17 - L_20_18 * y2_18 - L_20_19 * y2_19;
          double y2_21 = rhs2_21 - L_21_5 * y2_5 - L_21_10 * y2_10 - L_21_11 * y2_11 - L_21_12 * y2_12 - L_21_13 * y2_13 - L_21_14 * y2_14 - L_21_15 * y2_15 - L_21_16 * y2_16 - L_21_17 * y2_17 - L_21_18 * y2_18 - L_21_19 * y2_19 - L_21_20 * y2_20;
          double y2_22 = rhs2_22 - L_22_5 * y2_5 - L_22_10 * y2_10 - L_22_11 * y2_11 - L_22_12 * y2_12 - L_22_13 * y2_13 - L_22_14 * y2_14 - L_22_15 * y2_15 - L_22_16 * y2_16 - L_22_17 * y2_17 - L_22_18 * y2_18 - L_22_19 * y2_19 - L_22_20 * y2_20 - L_22_21 * y2_21;
          double y2_23 = rhs2_23 - L_23_5 * y2_5 - L_23_10 * y2_10 - L_23_11 * y2_11 - L_23_12 * y2_12 - L_23_13 * y2_13 - L_23_14 * y2_14 - L_23_15 * y2_15 - L_23_16 * y2_16 - L_23_17 * y2_17 - L_23_18 * y2_18 - L_23_19 * y2_19 - L_23_20 * y2_20 - L_23_21 * y2_21;
          double y2_24 = rhs2_24 - L_24_11 * y2_11 - L_24_14 * y2_14 - L_24_17 * y2_17 - L_24_20 * y2_20 - L_24_21 * y2_21;
          double y2_25 = rhs2_25 - L_25_12 * y2_12 - L_25_15 * y2_15 - L_25_18 * y2_18 - L_25_20 * y2_20 - L_25_21 * y2_21;
          ...
          double K2_4 = (y2_4 - U_4_10 * K2_10 - U_4_11 * K2_11 - U_4_12 * K2_12 - U_4_13 * K2_13 - U_4_14 * K2_14 - U_4_15 * K2_15 - U_4_16 * K2_16 - U_4_17 * K2_17 - U_4_18 * K2_18 - U_4_19 * K2_19) / U_4_4;
          double K2_5 = (y2_5 - U_5_10 * K2_10 - U_5_11 * K2_11 - U_5_12 * K2_12 - U_5_13 * K2_13 - U_5_14 * K2_14 - U_5_15 * K2_15 - U_5_16 * K2_16 - U_5_17 * K2_17 - U_5_18 * K2_18 - U_5_19 * K2_19 - U_5_20 * K2_20 - U_5_21 * K2_21) / U_5_5;
