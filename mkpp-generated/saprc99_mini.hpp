...
namespace mkpp {
  ...
  struct SolverKernels {
      ...
      KOKKOS_INLINE_FUNCTION void compute_rates(const StateView& state, RateView& F_block, const double* jvals) const {
          ...
          // F_block(O3): d[O3]/dt
          F_block(Species::O3) = 5.6800000000000035e-34*state(12)*state(13)*state(9) - 1.8706578944791917e-14*state(2)*state(0) - 3.719090969046838e-17*state(3)*state(0) - 8.335555444507484e-15*state(0)*state(9);
          ...
          F_block(Species::NO2) = 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(5)/(1.3459847134690284e-18*state(12) + 1.0) - 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) + 1.0*state(7)*jvals[2] + 5.1945007199592134e-11*state(2)*state(4) + 1.8706578944791917e-14*state(2)*state(0) - 3.719090969046838e-17*state(3)*state(0) - 1.0*state(3)*jvals[0];
          // F_block(NO3): d[NO3]/dt
          F_block(Species::NO3) = 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(5)/(1.3459847134690284e-18*state(12) + 1.0) - 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) + 1.0*state(7)*state(10)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14) - 2.5972503599796067e-11*state(2)*state(4) + 3.719090969046838e-17*state(3)*state(0);
          // F_block(N2O5): d[N2O5]/dt
          F_block(Species::N2O5) = -1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(5)/(1.3459847134690284e-18*state(12) + 1.0) + 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)*state(4)/(1.3846843902855162e-18*state(12) + 1.0);
          // F_block(HONO): d[HONO]/dt
          F_block(Species::HONO) = -1.0*state(6)*jvals[1];
          // F_block(HNO3): d[HNO3]/dt
          F_block(Species::HNO3) = -1.0*state(7)*state(10)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14) - 1.0*state(7)*jvals[2];
          // F_block(HNO4): d[HNO4]/dt
          F_block(Species::HNO4) = 0.0;
          // F_block(O3P): d[O3P]/dt
          F_block(Species::O3P) = -5.6800000000000035e-34*state(12)*state(13)*state(9) + 1.0*state(3)*jvals[0] - 8.335555444507484e-15*state(0)*state(9);
          // F_block(OH): d[OH]/dt
          F_block(Species::OH) = 2.0*state(1)*jvals[3] - 1.0*state(7)*state(10)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14) + 1.0*state(7)*jvals[2] + 1.0*state(6)*jvals[1];
      ...
      KOKKOS_INLINE_FUNCTION void compute_jacobian(const StateView& state, JacView& J_block, const double* jvals) const {
          ...
          J_block(Species::O3, Species::O3) = -1.8706578944791917e-14*state(2) - 3.719090969046838e-17*state(3) - 8.335555444507484e-15*state(9);
          // J(O3, NO): d(d[O3]/dt) / d[NO]
          J_block(Species::O3, Species::NO) = -1.8706578944791917e-14*state(0);
          // J(O3, NO2): d(d[O3]/dt) / d[NO2]
          J_block(Species::O3, Species::NO2) = -3.719090969046838e-17*state(0);
          // J(O3, O3P): d(d[O3]/dt) / d[O3P]
          J_block(Species::O3, Species::O3P) = 5.6800000000000035e-34*state(12)*state(13) - 8.335555444507484e-15*state(0);
          ...
          J_block(Species::NO2, Species::O3) = 1.8706578944791917e-14*state(2) - 3.719090969046838e-17*state(3);
          ...
          J_block(Species::NO2, Species::NO2) = -2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) - 3.719090969046838e-17*state(0) - 1.0*jvals[0];
          // J(NO2, NO3): d(d[NO2]/dt) / d[NO3]
          J_block(Species::NO2, Species::NO3) = -2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)/(1.3846843902855162e-18*state(12) + 1.0) + 5.1945007199592134e-11*state(2);
          // J(NO2, N2O5): d(d[NO2]/dt) / d[N2O5]
          J_block(Species::NO2, Species::N2O5) = 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)/(1.3459847134690284e-18*state(12) + 1.0);
          // J(NO2, HNO3): d(d[NO2]/dt) / d[HNO3]
          J_block(Species::NO2, Species::HNO3) = 1.0*jvals[2];
          // J(NO2, AIR): d(d[NO2]/dt) / d[AIR]
          J_block(Species::NO2, Species::AIR) = -1.6029099488139965e-37*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(5)/pow(1.3459847134690284e-18*state(12) + 1.0, 2) + 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)/(1.3459847134690284e-18*state(12) + 1.0) + 1.9018580488528996e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)*log(1.3459847134690284e-18*state(12))/((1.3459847134690284e-18*state(12) + 1.0)*pow(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) + 3.832146105553078e-48*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)*state(4)/pow(1.3846843902855162e-18*state(12) + 1.0, 2) - 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) - 4.4197770694650986e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)*log(1.3846843902855162e-18*state(12))/((1.3846843902855162e-18*state(12) + 1.0)*pow(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10));
          // J(NO3, O3): d(d[NO3]/dt) / d[O3]
          J_block(Species::NO3, Species::O3) = 3.719090969046838e-17*state(3);
          // J(NO3, NO): d(d[NO3]/dt) / d[NO]
          J_block(Species::NO3, Species::NO) = -2.5972503599796067e-11*state(4);
          // J(NO3, NO2): d(d[NO3]/dt) / d[NO2]
          J_block(Species::NO3, Species::NO2) = -2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) + 3.719090969046838e-17*state(0);
          // J(NO3, NO3): d(d[NO3]/dt) / d[NO3]
          J_block(Species::NO3, Species::NO3) = -2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)/(1.3846843902855162e-18*state(12) + 1.0) - 2.5972503599796067e-11*state(2);
          // J(NO3, N2O5): d(d[NO3]/dt) / d[N2O5]
          J_block(Species::NO3, Species::N2O5) = 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)/(1.3459847134690284e-18*state(12) + 1.0);
          // J(NO3, HNO3): d(d[NO3]/dt) / d[HNO3]
          J_block(Species::NO3, Species::HNO3) = 1.0*state(10)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14);
          // J(NO3, OH): d(d[NO3]/dt) / d[OH]
          J_block(Species::NO3, Species::OH) = 1.0*state(7)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14);
          // J(NO3, AIR): d(d[NO3]/dt) / d[AIR]
          J_block(Species::NO3, Species::AIR) = -1.6029099488139965e-37*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(5)/pow(1.3459847134690284e-18*state(12) + 1.0, 2) + 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)/(1.3459847134690284e-18*state(12) + 1.0) + 1.9018580488528996e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)*log(1.3459847134690284e-18*state(12))/((1.3459847134690284e-18*state(12) + 1.0)*pow(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) + 3.832146105553078e-48*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)*state(4)/pow(1.3846843902855162e-18*state(12) + 1.0, 2) - 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) - 4.4197770694650986e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)*log(1.3846843902855162e-18*state(12))/((1.3846843902855162e-18*state(12) + 1.0)*pow(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) + 1.0*state(7)*state(10)*(-9.103320389717082e-51*state(12)/pow(4.274656571958131e-19*state(12) + 1.0, 2) + 2.1296027497121323e-32/(4.274656571958131e-19*state(12) + 1.0));
          // J(N2O5, NO2): d(d[N2O5]/dt) / d[NO2]
          J_block(Species::N2O5, Species::NO2) = 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(4)/(1.3846843902855162e-18*state(12) + 1.0);
          // J(N2O5, NO3): d(d[N2O5]/dt) / d[NO3]
          J_block(Species::N2O5, Species::NO3) = 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)/(1.3846843902855162e-18*state(12) + 1.0);
          // J(N2O5, N2O5): d(d[N2O5]/dt) / d[N2O5]
          J_block(Species::N2O5, Species::N2O5) = -1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)/(1.3459847134690284e-18*state(12) + 1.0);
          // J(N2O5, AIR): d(d[N2O5]/dt) / d[AIR]
          J_block(Species::N2O5, Species::AIR) = 1.6029099488139965e-37*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(5)/pow(1.3459847134690284e-18*state(12) + 1.0, 2) - 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)/(1.3459847134690284e-18*state(12) + 1.0) - 1.9018580488528996e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)*log(1.3459847134690284e-18*state(12))/((1.3459847134690284e-18*state(12) + 1.0)*pow(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) - 3.832146105553078e-48*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)*state(4)/pow(1.3846843902855162e-18*state(12) + 1.0, 2) + 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) + 4.4197770694650986e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)*log(1.3846843902855162e-18*state(12))/((1.3846843902855162e-18*state(12) + 1.0)*pow(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10));
          // J(HONO, HONO): d(d[HONO]/dt) / d[HONO]
          J_block(Species::HONO, Species::HONO) = -1.0*jvals[1];
          // J(HNO3, HNO3): d(d[HNO3]/dt) / d[HNO3]
          J_block(Species::HNO3, Species::HNO3) = -1.0*state(10)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14) - 1.0*jvals[2];
          // J(HNO3, OH): d(d[HNO3]/dt) / d[OH]
          J_block(Species::HNO3, Species::OH) = -1.0*state(7)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14);
          // J(HNO3, AIR): d(d[HNO3]/dt) / d[AIR]
          J_block(Species::HNO3, Species::AIR) = -1.0*state(7)*state(10)*(-9.103320389717082e-51*state(12)/pow(4.274656571958131e-19*state(12) + 1.0, 2) + 2.1296027497121323e-32/(4.274656571958131e-19*state(12) + 1.0));
          // J(O3P, O3): d(d[O3P]/dt) / d[O3]
          J_block(Species::O3P, Species::O3) = -8.335555444507484e-15*state(9);
          // J(O3P, NO2): d(d[O3P]/dt) / d[NO2]
          J_block(Species::O3P, Species::NO2) = 1.0*jvals[0];
          // J(O3P, O3P): d(d[O3P]/dt) / d[O3P]
          J_block(Species::O3P, Species::O3P) = -5.6800000000000035e-34*state(12)*state(13) - 8.335555444507484e-15*state(0);
          ...
          J_block(Species::OH, Species::HNO3) = -1.0*state(10)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14) + 1.0*jvals[2];
          // J(OH, OH): d(d[OH]/dt) / d[OH]
          J_block(Species::OH, Species::OH) = -1.0*state(7)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14);
          // J(OH, AIR): d(d[OH]/dt) / d[AIR]
          J_block(Species::OH, Species::AIR) = -1.0*state(7)*state(10)*(-9.103320389717082e-51*state(12)/pow(4.274656571958131e-19*state(12) + 1.0, 2) + 2.1296027497121323e-32/(4.274656571958131e-19*state(12) + 1.0));
      ...
      KOKKOS_INLINE_FUNCTION void compute_adjoint(const StateView& state, JacView& J_adj_block, const double* jvals) const {
          ...
          J_adj_block(Species::O3, Species::O3) = -1.8706578944791917e-14*state(2) - 3.719090969046838e-17*state(3) - 8.335555444507484e-15*state(9);
          // J^T(O3, NO): d(d[NO]/dt) / d[O3]
          J_adj_block(Species::O3, Species::NO) = -1.8706578944791917e-14*state(2);
          // J^T(O3, NO2): d(d[NO2]/dt) / d[O3]
          J_adj_block(Species::O3, Species::NO2) = 1.8706578944791917e-14*state(2) - 3.719090969046838e-17*state(3);
          // J^T(O3, NO3): d(d[NO3]/dt) / d[O3]
          J_adj_block(Species::O3, Species::NO3) = 3.719090969046838e-17*state(3);
          // J^T(O3, O3P): d(d[O3P]/dt) / d[O3]
          J_adj_block(Species::O3, Species::O3P) = -8.335555444507484e-15*state(9);
          ...
          J_adj_block(Species::NO2, Species::O3) = -3.719090969046838e-17*state(0);
          // J^T(NO2, NO): d(d[NO]/dt) / d[NO2]
          J_adj_block(Species::NO2, Species::NO) = 1.0*jvals[0];
          // J^T(NO2, NO2): d(d[NO2]/dt) / d[NO2]
          J_adj_block(Species::NO2, Species::NO2) = -2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) - 3.719090969046838e-17*state(0) - 1.0*jvals[0];
          // J^T(NO2, NO3): d(d[NO3]/dt) / d[NO2]
          J_adj_block(Species::NO2, Species::NO3) = -2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) + 3.719090969046838e-17*state(0);
          // J^T(NO2, N2O5): d(d[N2O5]/dt) / d[NO2]
          J_adj_block(Species::NO2, Species::N2O5) = 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(4)/(1.3846843902855162e-18*state(12) + 1.0);
          ...
          J_adj_block(Species::NO3, Species::NO2) = -2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)/(1.3846843902855162e-18*state(12) + 1.0) + 5.1945007199592134e-11*state(2);
          // J^T(NO3, NO3): d(d[NO3]/dt) / d[NO3]
          J_adj_block(Species::NO3, Species::NO3) = -2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)/(1.3846843902855162e-18*state(12) + 1.0) - 2.5972503599796067e-11*state(2);
          // J^T(NO3, N2O5): d(d[N2O5]/dt) / d[NO3]
          J_adj_block(Species::NO3, Species::N2O5) = 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)/(1.3846843902855162e-18*state(12) + 1.0);
          // J^T(N2O5, NO2): d(d[NO2]/dt) / d[N2O5]
          J_adj_block(Species::N2O5, Species::NO2) = 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)/(1.3459847134690284e-18*state(12) + 1.0);
          // J^T(N2O5, NO3): d(d[NO3]/dt) / d[N2O5]
          J_adj_block(Species::N2O5, Species::NO3) = 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)/(1.3459847134690284e-18*state(12) + 1.0);
          // J^T(N2O5, N2O5): d(d[N2O5]/dt) / d[N2O5]
          J_adj_block(Species::N2O5, Species::N2O5) = -1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)/(1.3459847134690284e-18*state(12) + 1.0);
          ...
          J_adj_block(Species::HNO3, Species::NO3) = 1.0*state(10)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14);
          // J^T(HNO3, HNO3): d(d[HNO3]/dt) / d[HNO3]
          J_adj_block(Species::HNO3, Species::HNO3) = -1.0*state(10)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14) - 1.0*jvals[2];
          // J^T(HNO3, OH): d(d[OH]/dt) / d[HNO3]
          J_adj_block(Species::HNO3, Species::OH) = -1.0*state(10)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14) + 1.0*jvals[2];
          // J^T(O3P, O3): d(d[O3]/dt) / d[O3P]
          J_adj_block(Species::O3P, Species::O3) = 5.6800000000000035e-34*state(12)*state(13) - 8.335555444507484e-15*state(0);
          // J^T(O3P, O3P): d(d[O3P]/dt) / d[O3P]
          J_adj_block(Species::O3P, Species::O3P) = -5.6800000000000035e-34*state(12)*state(13) - 8.335555444507484e-15*state(0);
          // J^T(OH, NO3): d(d[NO3]/dt) / d[OH]
          J_adj_block(Species::OH, Species::NO3) = 1.0*state(7)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14);
          // J^T(OH, HNO3): d(d[HNO3]/dt) / d[OH]
          J_adj_block(Species::OH, Species::HNO3) = -1.0*state(7)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14);
          // J^T(OH, OH): d(d[OH]/dt) / d[OH]
          J_adj_block(Species::OH, Species::OH) = -1.0*state(7)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14);
          ...
          J_adj_block(Species::AIR, Species::NO2) = -1.6029099488139965e-37*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(5)/pow(1.3459847134690284e-18*state(12) + 1.0, 2) + 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)/(1.3459847134690284e-18*state(12) + 1.0) + 1.9018580488528996e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)*log(1.3459847134690284e-18*state(12))/((1.3459847134690284e-18*state(12) + 1.0)*pow(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) + 3.832146105553078e-48*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)*state(4)/pow(1.3846843902855162e-18*state(12) + 1.0, 2) - 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) - 4.4197770694650986e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)*log(1.3846843902855162e-18*state(12))/((1.3846843902855162e-18*state(12) + 1.0)*pow(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10));
          // J^T(AIR, NO3): d(d[NO3]/dt) / d[AIR]
          J_adj_block(Species::AIR, Species::NO3) = -1.6029099488139965e-37*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(5)/pow(1.3459847134690284e-18*state(12) + 1.0, 2) + 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)/(1.3459847134690284e-18*state(12) + 1.0) + 1.9018580488528996e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)*log(1.3459847134690284e-18*state(12))/((1.3459847134690284e-18*state(12) + 1.0)*pow(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) + 3.832146105553078e-48*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)*state(4)/pow(1.3846843902855162e-18*state(12) + 1.0, 2) - 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) - 4.4197770694650986e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)*log(1.3846843902855162e-18*state(12))/((1.3846843902855162e-18*state(12) + 1.0)*pow(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) + 1.0*state(7)*state(10)*(-9.103320389717082e-51*state(12)/pow(4.274656571958131e-19*state(12) + 1.0, 2) + 2.1296027497121323e-32/(4.274656571958131e-19*state(12) + 1.0));
          // J^T(AIR, N2O5): d(d[N2O5]/dt) / d[AIR]
          J_adj_block(Species::AIR, Species::N2O5) = 1.6029099488139965e-37*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(5)/pow(1.3459847134690284e-18*state(12) + 1.0, 2) - 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)/(1.3459847134690284e-18*state(12) + 1.0) - 1.9018580488528996e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)*log(1.3459847134690284e-18*state(12))/((1.3459847134690284e-18*state(12) + 1.0)*pow(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) - 3.832146105553078e-48*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)*state(4)/pow(1.3846843902855162e-18*state(12) + 1.0, 2) + 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) + 4.4197770694650986e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)*log(1.3846843902855162e-18*state(12))/((1.3846843902855162e-18*state(12) + 1.0)*pow(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10));
          // J^T(AIR, HNO3): d(d[HNO3]/dt) / d[AIR]
          J_adj_block(Species::AIR, Species::HNO3) = -1.0*state(7)*state(10)*(-9.103320389717082e-51*state(12)/pow(4.274656571958131e-19*state(12) + 1.0, 2) + 2.1296027497121323e-32/(4.274656571958131e-19*state(12) + 1.0));
          ...
          J_adj_block(Species::AIR, Species::OH) = -1.0*state(7)*state(10)*(-9.103320389717082e-51*state(12)/pow(4.274656571958131e-19*state(12) + 1.0, 2) + 2.1296027497121323e-32/(4.274656571958131e-19*state(12) + 1.0));
      ...
      KOKKOS_INLINE_FUNCTION void compute_tlm(const StateView& state, const DeltaView& delta_C, RateView& dF_block, const double* jvals) const {
          dF_block(0) = 0.0;
          dF_block(0) += (-1.8706578944791917e-14*state(2) - 3.719090969046838e-17*state(3) - 8.335555444507484e-15*state(9)) * delta_C(0);
          dF_block(0) += (-1.8706578944791917e-14*state(0)) * delta_C(2);
          dF_block(0) += (-3.719090969046838e-17*state(0)) * delta_C(3);
          dF_block(0) += (5.6800000000000035e-34*state(12)*state(13) - 8.335555444507484e-15*state(0)) * delta_C(9);
          ...
          dF_block(3) = 0.0;
          dF_block(3) += (1.8706578944791917e-14*state(2) - 3.719090969046838e-17*state(3)) * delta_C(0);
          dF_block(3) += (5.1945007199592134e-11*state(4) + 1.8706578944791917e-14*state(0)) * delta_C(2);
          dF_block(3) += (-2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) - 3.719090969046838e-17*state(0) - 1.0*jvals[0]) * delta_C(3);
          dF_block(3) += (-2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)/(1.3846843902855162e-18*state(12) + 1.0) + 5.1945007199592134e-11*state(2)) * delta_C(4);
          dF_block(3) += (1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)/(1.3459847134690284e-18*state(12) + 1.0)) * delta_C(5);
          dF_block(3) += (1.0*jvals[2]) * delta_C(7);
          dF_block(3) += (-1.6029099488139965e-37*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(5)/pow(1.3459847134690284e-18*state(12) + 1.0, 2) + 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)/(1.3459847134690284e-18*state(12) + 1.0) + 1.9018580488528996e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)*log(1.3459847134690284e-18*state(12))/((1.3459847134690284e-18*state(12) + 1.0)*pow(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) + 3.832146105553078e-48*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)*state(4)/pow(1.3846843902855162e-18*state(12) + 1.0, 2) - 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) - 4.4197770694650986e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)*log(1.3846843902855162e-18*state(12))/((1.3846843902855162e-18*state(12) + 1.0)*pow(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10))) * delta_C(12);
          dF_block(4) = 0.0;
          dF_block(4) += (3.719090969046838e-17*state(3)) * delta_C(0);
          dF_block(4) += (-2.5972503599796067e-11*state(4)) * delta_C(2);
          dF_block(4) += (-2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) + 3.719090969046838e-17*state(0)) * delta_C(3);
          dF_block(4) += (-2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)/(1.3846843902855162e-18*state(12) + 1.0) - 2.5972503599796067e-11*state(2)) * delta_C(4);
          dF_block(4) += (1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)/(1.3459847134690284e-18*state(12) + 1.0)) * delta_C(5);
          dF_block(4) += (1.0*state(10)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14)) * delta_C(7);
          dF_block(4) += (1.0*state(7)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14)) * delta_C(10);
          dF_block(4) += (-1.6029099488139965e-37*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(5)/pow(1.3459847134690284e-18*state(12) + 1.0, 2) + 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)/(1.3459847134690284e-18*state(12) + 1.0) + 1.9018580488528996e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)*log(1.3459847134690284e-18*state(12))/((1.3459847134690284e-18*state(12) + 1.0)*pow(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) + 3.832146105553078e-48*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)*state(4)/pow(1.3846843902855162e-18*state(12) + 1.0, 2) - 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) - 4.4197770694650986e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)*log(1.3846843902855162e-18*state(12))/((1.3846843902855162e-18*state(12) + 1.0)*pow(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) + 1.0*state(7)*state(10)*(-9.103320389717082e-51*state(12)/pow(4.274656571958131e-19*state(12) + 1.0, 2) + 2.1296027497121323e-32/(4.274656571958131e-19*state(12) + 1.0))) * delta_C(12);
          dF_block(5) = 0.0;
          dF_block(5) += (2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(4)/(1.3846843902855162e-18*state(12) + 1.0)) * delta_C(3);
          dF_block(5) += (2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)/(1.3846843902855162e-18*state(12) + 1.0)) * delta_C(4);
          dF_block(5) += (-1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)/(1.3459847134690284e-18*state(12) + 1.0)) * delta_C(5);
          dF_block(5) += (1.6029099488139965e-37*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(5)/pow(1.3459847134690284e-18*state(12) + 1.0, 2) - 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)/(1.3459847134690284e-18*state(12) + 1.0) - 1.9018580488528996e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(5)*log(1.3459847134690284e-18*state(12))/((1.3459847134690284e-18*state(12) + 1.0)*pow(pow(log(1.3459847134690284e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) - 3.832146105553078e-48*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(12)*state(3)*state(4)/pow(1.3846843902855162e-18*state(12) + 1.0, 2) + 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)/(1.3846843902855162e-18*state(12) + 1.0) + 4.4197770694650986e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0))*state(3)*state(4)*log(1.3846843902855162e-18*state(12))/((1.3846843902855162e-18*state(12) + 1.0)*pow(pow(log(1.3846843902855162e-18*state(12)), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10))) * delta_C(12);
          dF_block(6) = 0.0;
          dF_block(6) += (-1.0*jvals[1]) * delta_C(6);
          dF_block(7) = 0.0;
          dF_block(7) += (-1.0*state(10)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14) - 1.0*jvals[2]) * delta_C(7);
          dF_block(7) += (-1.0*state(7)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14)) * delta_C(10);
          dF_block(7) += (-1.0*state(7)*state(10)*(-9.103320389717082e-51*state(12)/pow(4.274656571958131e-19*state(12) + 1.0, 2) + 2.1296027497121323e-32/(4.274656571958131e-19*state(12) + 1.0))) * delta_C(12);
          dF_block(8) = 0.0;
          dF_block(9) = 0.0;
          dF_block(9) += (-8.335555444507484e-15*state(9)) * delta_C(0);
          dF_block(9) += (1.0*jvals[0]) * delta_C(3);
          dF_block(9) += (-5.6800000000000035e-34*state(12)*state(13) - 8.335555444507484e-15*state(0)) * delta_C(9);
          ...
          dF_block(10) += (-1.0*state(10)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14) + 1.0*jvals[2]) * delta_C(7);
          dF_block(10) += (-1.0*state(7)*(2.1296027497121323e-32*state(12)/(4.274656571958131e-19*state(12) + 1.0) + 9.856810126549438e-14)) * delta_C(10);
          dF_block(10) += (-1.0*state(7)*state(10)*(-9.103320389717082e-51*state(12)/pow(4.274656571958131e-19*state(12) + 1.0, 2) + 2.1296027497121323e-32/(4.274656571958131e-19*state(12) + 1.0))) * delta_C(12);
          dF_block(11) = 0.0;
      ...
      KOKKOS_INLINE_FUNCTION void integrate(double dt_total, StateView& state, const double* jvals) const {
          ...
          double J_7_7 = -2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_8/(1.3846843902855162e-18*S_14 + 1.0) - 2.5972503599796067e-11*S_4;
          double J_7_8 = -2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_7/(1.3846843902855162e-18*S_14 + 1.0) + 3.719090969046838e-17*S_9;
          double J_7_9 = 3.719090969046838e-17*S_8;
          double J_7_11 = 1.0*S_13*(2.1296027497121323e-32*S_14/(4.274656571958131e-19*S_14 + 1.0) + 9.856810126549438e-14);
          double J_7_12 = 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14/(1.3459847134690284e-18*S_14 + 1.0);
          double J_7_13 = 1.0*S_11*(2.1296027497121323e-32*S_14/(4.274656571958131e-19*S_14 + 1.0) + 9.856810126549438e-14);
          double J_7_14 = -1.6029099488139965e-37*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_12/pow(1.3459847134690284e-18*S_14 + 1.0, 2) + 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_12/(1.3459847134690284e-18*S_14 + 1.0) + 1.9018580488528996e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_12*log(1.3459847134690284e-18*S_14)/((1.3459847134690284e-18*S_14 + 1.0)*pow(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) + 3.832146105553078e-48*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_8*S_7/pow(1.3846843902855162e-18*S_14 + 1.0, 2) - 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_8*S_7/(1.3846843902855162e-18*S_14 + 1.0) - 4.4197770694650986e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_8*S_7*log(1.3846843902855162e-18*S_14)/((1.3846843902855162e-18*S_14 + 1.0)*pow(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) + 1.0*S_11*S_13*(-9.103320389717082e-51*S_14/pow(4.274656571958131e-19*S_14 + 1.0, 2) + 2.1296027497121323e-32/(4.274656571958131e-19*S_14 + 1.0));
          double J_8_4 = 5.1945007199592134e-11*S_7 + 1.8706578944791917e-14*S_9;
          double J_8_7 = -2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_8/(1.3846843902855162e-18*S_14 + 1.0) + 5.1945007199592134e-11*S_4;
          double J_8_8 = -2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_7/(1.3846843902855162e-18*S_14 + 1.0) - 3.719090969046838e-17*S_9 - 1.0*jvals[0];
          double J_8_9 = 1.8706578944791917e-14*S_4 - 3.719090969046838e-17*S_8;
          double J_8_11 = 1.0*jvals[2];
          double J_8_12 = 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14/(1.3459847134690284e-18*S_14 + 1.0);
          double J_8_14 = -1.6029099488139965e-37*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_12/pow(1.3459847134690284e-18*S_14 + 1.0, 2) + 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_12/(1.3459847134690284e-18*S_14 + 1.0) + 1.9018580488528996e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_12*log(1.3459847134690284e-18*S_14)/((1.3459847134690284e-18*S_14 + 1.0)*pow(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) + 3.832146105553078e-48*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_8*S_7/pow(1.3846843902855162e-18*S_14 + 1.0, 2) - 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_8*S_7/(1.3846843902855162e-18*S_14 + 1.0) - 4.4197770694650986e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_8*S_7*log(1.3846843902855162e-18*S_14)/((1.3846843902855162e-18*S_14 + 1.0)*pow(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10));
          double J_9_4 = -1.8706578944791917e-14*S_9;
          double J_9_5 = 5.6800000000000035e-34*S_14*S_10;
          double J_9_8 = -3.719090969046838e-17*S_9;
          double J_9_9 = -1.8706578944791917e-14*S_4 - 3.719090969046838e-17*S_8 - 8.335555444507484e-15*S_10;
          double J_9_10 = 5.6800000000000035e-34*S_14*S_5 - 8.335555444507484e-15*S_9;
          double J_9_14 = 5.6800000000000035e-34*S_5*S_10;
          double J_10_5 = -5.6800000000000035e-34*S_14*S_10;
          double J_10_8 = 1.0*jvals[0];
          double J_10_9 = -8.335555444507484e-15*S_10;
          double J_10_10 = -5.6800000000000035e-34*S_14*S_5 - 8.335555444507484e-15*S_9;
          double J_10_14 = -5.6800000000000035e-34*S_5*S_10;
          double J_11_11 = -1.0*S_13*(2.1296027497121323e-32*S_14/(4.274656571958131e-19*S_14 + 1.0) + 9.856810126549438e-14) - 1.0*jvals[2];
          double J_11_13 = -1.0*S_11*(2.1296027497121323e-32*S_14/(4.274656571958131e-19*S_14 + 1.0) + 9.856810126549438e-14);
          double J_11_14 = -1.0*S_11*S_13*(-9.103320389717082e-51*S_14/pow(4.274656571958131e-19*S_14 + 1.0, 2) + 2.1296027497121323e-32/(4.274656571958131e-19*S_14 + 1.0));
          double J_12_7 = 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_8/(1.3846843902855162e-18*S_14 + 1.0);
          double J_12_8 = 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_7/(1.3846843902855162e-18*S_14 + 1.0);
          double J_12_12 = -1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14/(1.3459847134690284e-18*S_14 + 1.0);
          double J_12_14 = 1.6029099488139965e-37*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_12/pow(1.3459847134690284e-18*S_14 + 1.0, 2) - 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_12/(1.3459847134690284e-18*S_14 + 1.0) - 1.9018580488528996e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_12*log(1.3459847134690284e-18*S_14)/((1.3459847134690284e-18*S_14 + 1.0)*pow(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10)) - 3.832146105553078e-48*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_8*S_7/pow(1.3846843902855162e-18*S_14 + 1.0, 2) + 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_8*S_7/(1.3846843902855162e-18*S_14 + 1.0) + 4.4197770694650986e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_8*S_7*log(1.3846843902855162e-18*S_14)/((1.3846843902855162e-18*S_14 + 1.0)*pow(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0, 2)*(M_LN10 * M_LN10));
          double J_13_6 = 1.0*jvals[1];
          double J_13_11 = -1.0*S_13*(2.1296027497121323e-32*S_14/(4.274656571958131e-19*S_14 + 1.0) + 9.856810126549438e-14) + 1.0*jvals[2];
          double J_13_13 = -1.0*S_11*(2.1296027497121323e-32*S_14/(4.274656571958131e-19*S_14 + 1.0) + 9.856810126549438e-14);
          double J_13_14 = -1.0*S_11*S_13*(-9.103320389717082e-51*S_14/pow(4.274656571958131e-19*S_14 + 1.0, 2) + 2.1296027497121323e-32/(4.274656571958131e-19*S_14 + 1.0));
          ...
          double F1_7 = 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_12/(1.3459847134690284e-18*S_14 + 1.0) - 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_8*S_7/(1.3846843902855162e-18*S_14 + 1.0) + 1.0*S_11*S_13*(2.1296027497121323e-32*S_14/(4.274656571958131e-19*S_14 + 1.0) + 9.856810126549438e-14) - 2.5972503599796067e-11*S_4*S_7 + 3.719090969046838e-17*S_8*S_9;
          double F1_8 = 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_12/(1.3459847134690284e-18*S_14 + 1.0) - 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_8*S_7/(1.3846843902855162e-18*S_14 + 1.0) + 1.0*S_11*jvals[2] + 5.1945007199592134e-11*S_4*S_7 + 1.8706578944791917e-14*S_4*S_9 - 3.719090969046838e-17*S_8*S_9 - 1.0*S_8*jvals[0];
          double F1_9 = 5.6800000000000035e-34*S_14*S_5*S_10 - 1.8706578944791917e-14*S_4*S_9 - 3.719090969046838e-17*S_8*S_9 - 8.335555444507484e-15*S_9*S_10;
          double F1_10 = -5.6800000000000035e-34*S_14*S_5*S_10 + 1.0*S_8*jvals[0] - 8.335555444507484e-15*S_9*S_10;
          double F1_11 = -1.0*S_11*S_13*(2.1296027497121323e-32*S_14/(4.274656571958131e-19*S_14 + 1.0) + 9.856810126549438e-14) - 1.0*S_11*jvals[2];
          double F1_12 = -1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_12/(1.3459847134690284e-18*S_14 + 1.0) + 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*S_14), 2)/(M_LN10 * M_LN10) + 1.0))*S_14*S_8*S_7/(1.3846843902855162e-18*S_14 + 1.0);
          double F1_13 = 2.0*S_15*jvals[3] - 1.0*S_11*S_13*(2.1296027497121323e-32*S_14/(4.274656571958131e-19*S_14 + 1.0) + 9.856810126549438e-14) + 1.0*S_11*jvals[2] + 1.0*S_6*jvals[1];
          double F1_14 = 0.0;
          ...
          double F2_7 = 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*Y2_14), 2)/(M_LN10 * M_LN10) + 1.0))*Y2_14*Y2_12/(1.3459847134690284e-18*Y2_14 + 1.0) - 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*Y2_14), 2)/(M_LN10 * M_LN10) + 1.0))*Y2_14*Y2_8*Y2_7/(1.3846843902855162e-18*Y2_14 + 1.0) + 1.0*Y2_11*Y2_13*(2.1296027497121323e-32*Y2_14/(4.274656571958131e-19*Y2_14 + 1.0) + 9.856810126549438e-14) - 2.5972503599796067e-11*Y2_4*Y2_7 + 3.719090969046838e-17*Y2_8*Y2_9;
          double F2_8 = 1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*Y2_14), 2)/(M_LN10 * M_LN10) + 1.0))*Y2_14*Y2_12/(1.3459847134690284e-18*Y2_14 + 1.0) - 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*Y2_14), 2)/(M_LN10 * M_LN10) + 1.0))*Y2_14*Y2_8*Y2_7/(1.3846843902855162e-18*Y2_14 + 1.0) + 1.0*Y2_11*jvals[2] + 5.1945007199592134e-11*Y2_4*Y2_7 + 1.8706578944791917e-14*Y2_4*Y2_9 - 3.719090969046838e-17*Y2_8*Y2_9 - 1.0*Y2_8*jvals[0];
          double F2_9 = 5.6800000000000035e-34*Y2_14*Y2_5*Y2_10 - 1.8706578944791917e-14*Y2_4*Y2_9 - 3.719090969046838e-17*Y2_8*Y2_9 - 8.335555444507484e-15*Y2_9*Y2_10;
          double F2_10 = -5.6800000000000035e-34*Y2_14*Y2_5*Y2_10 + 1.0*Y2_8*jvals[0] - 8.335555444507484e-15*Y2_9*Y2_10;
          double F2_11 = -1.0*Y2_11*Y2_13*(2.1296027497121323e-32*Y2_14/(4.274656571958131e-19*Y2_14 + 1.0) + 9.856810126549438e-14) - 1.0*Y2_11*jvals[2];
          double F2_12 = -1.1908827290339734e-19*pow(0.45, 1.0/(pow(log(1.3459847134690284e-18*Y2_14), 2)/(M_LN10 * M_LN10) + 1.0))*Y2_14*Y2_12/(1.3459847134690284e-18*Y2_14 + 1.0) + 2.7675231499958668e-30*pow(0.45, 1.0/(pow(log(1.3846843902855162e-18*Y2_14), 2)/(M_LN10 * M_LN10) + 1.0))*Y2_14*Y2_8*Y2_7/(1.3846843902855162e-18*Y2_14 + 1.0);
          double F2_13 = 2.0*Y2_15*jvals[3] - 1.0*Y2_11*Y2_13*(2.1296027497121323e-32*Y2_14/(4.274656571958131e-19*Y2_14 + 1.0) + 9.856810126549438e-14) + 1.0*Y2_11*jvals[2] + 1.0*Y2_6*jvals[1];
          double F2_14 = 0.0;
